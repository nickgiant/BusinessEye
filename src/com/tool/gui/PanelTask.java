...
//    	scrol.setViewportView(panelCenter);
   ...
   private void setStepNumber(int pgCurrent)
   {
   	 ...
   	 // System.out.println("PanelTask.setStepNumber "+pgCurrent+" "+pageTotal);
   ...
   private void execute()
   {
   	  ...
   	  //System.out.println("PanelTask.execute  "+strCalculationType);
      ...
      try
      {
   	...
   	for(int q=0;q<listEntityQuery.size();q++ )
   	{
         ...
         // if not null replace filter table
   	     ...
   	     {      
   	          //System.out.println("PanelTask.execute "+e+" "+entityFilterSettings[e].dbTable+" "+ent.length);
   	  ...
   	  else //if(table==null && table.equals(""))
   	  {
   	      ...
   	      //System.out.println("PanelTask.execute '"+table+"'"+entityFilterSettings[1].dbTable);
   	  }
       ...
       //System.out.println("PanelTask.execute >"+sqlWhere);
  	     
   	   if(entQuery.getQuery().contains("WHERE"))
       {
          sqlWhere=sqlWhere.replaceFirst("WHERE", "AND");
          //System.out.println("PanelTask.execute replace WHERE with AND");
       }
   	     ...
   	     if(entQuery.getIsUpdate())
   	     {
   	        ...
   	        //ret = db.updateQuery(sql,"PanelTask.execute", true);
   ...
   {       
    	...
    	public void actionPerformed(ActionEvent e)
      	{  
      	 ...
      	 // System.out.println("PanelTask.ActionSelectCalculationType "+intCalculationType);
