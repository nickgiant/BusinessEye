/*  // copied 17-01-2009
 *jEdit\org\gjt\sp\jedit\gui\
 *
 *http://www.koders.com/java/fid6FA448AAE012162314CD3618FA6D9C9E2A1A40AB.aspx?s=mdef%3ainsert
 * http://www.java2s.com/Open-Source/Java-Document/Swing-Library/jEdit/org/gjt/sp/jedit/gui/VariableGridLayout.java.htm
 *
 ...
 *     public void init() {
 *         setLayout(new GridLayoutVariable(GridLayoutVariable.FIXED_NUM_COLUMNS, 2));
 *         add(new Button("1"));
 *         add(new Button("2"));
 *         add(new Button("3"));
 *         add(new Button("4"));
 ...
 */
public class GridLayoutVariable implements LayoutManager2, java.io.Serializable
{
	...
	public GridLayoutVariable(int mode, int size, int hgap, int vgap) {
	 ...
	 */
	public GridLayoutVariable(int mode, int size) {
		this(mode, size, 0, 0);
	}
