...
String query4 = "SELECT dbcompany.dbCompanyId , dbcompany.companyName , dbcompany.companyVatNo , activitycat.activityDescr , geoCat.geoCatName , dbcompany.doyId  ,doy.doyname , active,  bank.bankBranch ,dbcompany.bankAccount ,dbcompany.bankAccountIBAN  FROM dbcompany LEFT JOIN doy ON dbcompany.doyId=doy.doyId LEFT JOIN geoCat ON dbcompany.geoCatId=geoCat.geoCatId LEFT JOIN bank ON dbcompany.bankId=bank.bankId  LEFT JOIN activitycat ON activitycat.activityCatId = dbcompany.activityCatId     ORDER BY  2 ASC WHERE dbcompany.dbCompanyId LIKE '2' AND service.dbCompanyId LIKE '1' ORDER BY  2 ASC";
