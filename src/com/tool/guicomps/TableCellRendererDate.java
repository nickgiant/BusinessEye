...
import com.tool.gui.*;
  ...
  public class TableCellRendererDate extends DefaultTableCellRenderer implements Constants
  {
  ...
  public void setValue(Object value)
  {
   ...
   if(value!=null)
   {
     ...
     value = utilsd.reformatDateStringToReadFromDB(dateString);
