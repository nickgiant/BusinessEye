...
public class JButtonMainMenu extends JButton implements Constants//ButtonCentralGradient//ButtonGradientOval//ButtonCentralGradient//JButtonMenu 
{
   //private CurvedGradientPanel panelAllOnIt ;
	...
	{	
        ...
        setOpaque(true);
        setBackground(Color.WHITE);//CLR_PANEL_END);//  CLR_PANEL_END   CLR_PANEL_START
        setBorder(BorderFactory.createLineBorder(Color.WHITE));//CLR_LBL_NORMAL_BORDER));
        this.addMouseListener(new MouseAdapter()
                {       	      
                 ...
                 public void mouseExited(MouseEvent e)
                 {
                    ...
                    setBackground(Color.WHITE);//CLR_PANEL_END);//  CLR_PANEL_END
                    //setOpaque(false);
                 }
