 ...
 */
public class JListDec extends JList implements Constants
{
    ...
    public JListDec( javax.swing.ListModel dataModel )
    {
        super( dataModel );
    }
    public JListDec( Object[] listData )
    {
        super( listData );
    }
    public JListDec( java.util.Vector<?> listData )
    {
        super( listData );
    }
