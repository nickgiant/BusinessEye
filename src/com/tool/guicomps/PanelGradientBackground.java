 ...
 *
 */
public class PanelGradientBackground extends JPanel implements Constants {
	 ...
	 */
	public PanelGradientBackground()
	{
		super();
	}


	public PanelGradientBackground(LayoutManager lm)
	{
		super(lm);
	 ...
	 */
	public PanelGradientBackground(Color aStart, Color aEnd) {
		super();
		startColor = aStart;
		endColor = aEnd;
	}
	 ...
	 *            The direction of the gradient.
	 */
	public PanelGradientBackground(Color aStart, Color aEnd, int aDirection) {
		super();
		startColor = aStart;
		endColor = aEnd;
...
g2.draw(new Arc2D.Double(10, 15, 1800,  950, 285, 399, Arc2D.OPEN));


// draw Arc2D.Double
g2.setStroke(wideStroke);
g2.draw(new Arc2D.Double(100, 150, 800,  900, 225, 345, Arc2D.OPEN));
