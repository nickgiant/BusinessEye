...
public class EntityDataPayroll extends EntityData implements Constants
{
    ...
    //----------------------------------------------------------------
     ...
     EntityPanel entityPanelΕfkaEidikotitaDataentry = new EntityPanel("ODOR","pay_efkaeidikotita",efkaEidikotitaDBFields,efkaEidikotitaEntityGroupOfComps,efkaEidikotitaEntityGroupOfPanels,"Νο","","efkaEidikotitaId",efkaEidikotitaQueryEditable,"βασικά στοιχεία",null, false, true,fieldsUniqueΕfkaEidikotita,1,UNIQUE_FIELDS_WHILE_DATAENTRY_EDITABLE_YES,1,UNIQUE_FIELDS_BEFORE_SAVE_EDITABLE_YES,false,false,null,null,null,entityCheckFieldsΕfkaEidikotita,null);  
       ...
       //---------------------------------------------------------------- 
        ...
        EntityDBFields[] payrollPeriodDBFields = new EntityDBFields[22];
  ...
  public void addDocumentNodes()
  {
   ...
   public ArrayList addEntitiesLookup(ArrayList entities)
   {
     ...
     String[] arrayLookupFieldsFilter ={"calculationYear","calculationperiodId","calculationperiodId","calculationYear"};
     entities.add(entityLookUp = new EntityLookUp("pay_employmentperiod_avail","pay_employmentperiod",
             "SELECT pay_employmentperiod.employmentPeriodId, dbCompany.title, pay_employmentperiod.employeeId, hr_employee.lastname, hr_employee.firstname, hr_employee.vatNo, hr_employee.amkaNo ,  actualEmploymentStartDate, actualEmploymentEndDate "+
             "FROM hr_employee, dbcompany, pay_employmentperiod ",//, pay_calculationperiod, pay_payrollperiod ", // where is an other parameter
             "WHERE pay_employmentperiod.employeeId = hr_employee.employeeId AND dbCompany.dbCompanyId = pay_employmentperiod.dbCompanyId "+       
             ...
             "SELECT pay_payrollperiod.employmentPeriodId "+
             "FROM pay_employmentperiod, pay_calculationperiod, pay_payrollperiod "+
      ...
      entities.add(entityLookUp = new EntityLookUp("pay_employmentperiod_todelete","pay_employmentperiod",
            ...
            "hr_employee.firstname, hr_employee.vatNo, hr_employee.amkaNo, pay_employmentperiod.actualEmploymentStartDate, pay_payrollperiod.daysWorked, pay_payrollperiod.salaryGross "+
...
// employmentperiodDBFields[3] = new EntityDBFields("pay_employmentperiod","active","ενεργή",0,"java.lang.Boolean",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"true","");            
 ...
 /*13*/ employmentperiodDBFields[22] = new EntityDBFields("pay_employmentperiod","typeOfHourOrDaywageOrSalaryId","τύπος εργαζόμενου",5,"java.lang.Integer",5, FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_TABLECONSTANTS,"LTCTypeOfSalary",FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,null,fieldsCalculationTypeOfSalary,"");
        ...
        */
        ...
        payrollPeriodDBFields[8] = new EntityDBFields("pay_payrollperiod","daysRegularWorked","daysRegularWorked",0,"java.lang.Integer",12,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        payrollPeriodDBFields[9] = new EntityDBFields("pay_payrollperiod","daysGiftWorked","daysGiftWorked",0,"java.lang.Integer",12,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        payrollPeriodDBFields[10] = new EntityDBFields("pay_payrollperiod","timePeriodCalculated","ημ/ώρα υπολογισμού",0,"java.lang.String",23,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");        
        
        payrollPeriodDBFields[11] = new EntityDBFields("pay_payrollperiod","codeEfkaKpk","κωδικός πακέτου κάλυψης",1,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"pay_efkakpk", FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");                
        payrollPeriodDBFields[12] = new EntityDBFields("pay_payrollperiod","taxCalcTypeId","τύπος υπολογισμού ΦΜΥ",1,"java.lang.Integer",10,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_TABLECONSTANTS,"LTCTypeOfTaxCalc", FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"1","");        
        payrollPeriodDBFields[13] = new EntityDBFields("pay_payrollperiod","deductionEmployeePercentage","% κρατ. εργαζόμενου",1,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");         
        payrollPeriodDBFields[14] = new EntityDBFields("pay_payrollperiod","deductionCompanyPercentage","% κρατ. εργοδότη",1,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");
       ...
       // payrollPeriodDBFields[13] = new EntityDBFields("pay_payrollperiod","endPayrollDate","εως ημερομηνία",4,"java.sql.Date",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
        payrollPeriodDBFields[15] = new EntityDBFields("pay_payrollperiod","salaryGross","μικτός μισθός",2,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");
        ...
        payrollPeriodDBFields[16] = new EntityDBFields("pay_payrollperiod","deductionEmployeeAmount","κρατ. εργαζόμενου",2,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");         
        payrollPeriodDBFields[17] = new EntityDBFields("pay_payrollperiod","deductionCompanyAmount","κρατ. εργοδότη",2,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");
        payrollPeriodDBFields[18] = new EntityDBFields("pay_payrollperiod","salaryNet","καθαρά",2,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");         
        payrollPeriodDBFields[19] = new EntityDBFields("pay_payrollperiod","deductionTotalAmount","σύν. κρατήσεων",2,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");         
        payrollPeriodDBFields[20] = new EntityDBFields("pay_payrollperiod","taxValue","ΦΜΥ",2,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");         
        payrollPeriodDBFields[21] = new EntityDBFields("pay_payrollperiod","totalCompanyExpence","συνολικό κόστος",2,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");         
