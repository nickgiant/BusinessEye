...
EntityFilterSettings[] salesDocumentErs = new EntityFilterSettings[7] ; 
     salesDocumentErs[0]=new EntityFilterSettings("χρήση","onelookup","string","","dbYearId","dbyear","saleheader", VariablesGlobal.globalYearId,0,-1,-1,FIELD_NOCOMPLETION);
       ...
       salesDocumentErs[2]=new EntityFilterSettings("συναλλασσόμενος","checkboxTable","string","","traderId","traderS","trader","",1,-1,-1,FIELD_NOCOMPLETION);
...
*/
        ...
        EntityCheckFields[] entityCheckFieldsTrader = null;
        entityPaneltraderDataentry = new EntityPanel("ODOR","trader",traderDBFields,traderEntityGroupOfComps,traderEntityGroupOfPanels,"Νο συναλλασσόμενου","","traderId",traderQueryEditable,"βασικά στοιχεία",ICO_EDIT16, false, true,fieldsUniquetrader,1,UNIQUE_FIELDS_WHILE_DATAENTRY_EDITABLE_YES,1,UNIQUE_FIELDS_BEFORE_SAVE_EDITABLE_YES,false,false,null,null/*hr*/,null,entityCheckFieldsTrader,null);  
        entityPaneltraderHistory = new EntityPanel("stattraderHistory","STATS",null,"ιστορικό πωλήσεων",ICO_STATISTICS16,"SELECT saleheader.traderId, saleheader.saleheaderId, saleheader.saleCodeOfDocument,saleheader.dbYearId, saleheader.dateOfSale, saleheader.isPrinted, saleheader.countTotal, saleheader.pricePreVat, saleheader.priceVat, saleheader.priceTotal","FROM saleheader LEFT JOIN actionseries ON saleheader.actionseriesId = actionseries.actionseriesId, trader","WHERE trader.traderId = saleheader.traderId AND saleheader.dbCompanyId = actionseries.dbCompanyId AND saleheader.dbCompanyId LIKE "+VariablesGlobal.globalCompanyId /*+" AND sxesoexoheader.traderId ="*/,"","ORDER BY saleheader.dateOfSale, saleheader.saleCodeOfDocument",false,"",false,"",entityPanelSale,fieldsOnTitleSale,fieldsOnTitleCaptionSale);     
        //EntityPanel entityPaneltraderProducts = new EntityPanel("stattraderProducts","STATS",null,"καλλιέργιες",ICO_STATISTICS16,"SELECT product.productId AS \"Νο προϊόντος\", product.productName AS \"προϊόν\",  COUNT(*) AS \"πλήθος\", SUM(invoice.value) AS \"σύνολο\"","FROM invoice, product","WHERE invoice.productId = product.productId AND invoice.traderId=","GROUP BY product.productId","ORDER BY product.productName",true,"invoice.dbCompanyId",true,"invoice.dbyear");
        //EntityPanel entityPaneltraderBuyers = new EntityPanel("stattraderBuyers","STATS",null,"αγοραστές",ICO_STATISTICS16,"SELECT buyer.buyerId AS \"νο αγοραστή\", buyer.buyerTitle,buyer.buyerAfm, COUNT(*) AS \"πλήθος\", SUM(invoice.value) AS \"σύνολο\"","FROM invoice, buyer","WHERE invoice.buyerId = buyer.buyerId AND invoice.traderId=","GROUP BY buyer.buyerId","ORDER BY buyer.buyerTitle",true,"invoice.dbCompanyId",true,"invoice.dbyear");
        //EntityPanel entityPaneltraderSalesPerDate = new EntityPanel("stattraderSalesPerDate","STATS",null,"πωλήσεις ανα μήνα",ICO_STATISTICS16,"SELECT returnMonth(date, 'no') AS \"ΝΟ\", returnMonth(date, 'name') AS \"ΜΗΝΑΣ\" , COUNT(*)AS \"ΠΛΗΘΟΣ\", SUM(invoice.value) AS \"ΣΥΝΟΛΟ\", AVG(invoice.value) AS \"Μ.Ο.\"","FROM invoice","WHERE invoice.traderId=","GROUP BY returnMonth(date, 'no'),returnMonth(date, 'name')","ORDER BY returnMonth(date, 'no')",true,"invoice.dbCompanyId",true,"invoice.dbyear");
        entityPaneltrader = new EntityPanel[] { entityPaneltraderDataentry,entityPaneltraderHistory};//,entityPaneltraderStatistics,entityPaneltraderProducts,entityPaneltraderBuyers,entityPaneltraderSalesPerDate};
	...
	traderBankaccountDBFields[4] = new EntityDBFields("traderbankaccount","account","λογαριασμός",0,"java.lang.String",18,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        ...
        saleLineDBFields[4] = new EntityDBFields("saleline","stockId","υπηρεσία",0,"java.lang.Integer",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"stock",FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,null,fieldsCalculationServiceSelect,"");
	saleLineDBFields[5] = new EntityDBFields("saleline","description","περ/φή υπηρεσίας",0,"java.lang.String",18,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
       ...
       //9,inputPriceBeforeVat,"*");//,"SELECT vatcat.priceWhole FROM stock, vatcat  WHERE stock.vatCatId=vatcat.vatCatId AND stock.dbCompanyId LIKE "+VariablesGlobal.globalCompanyId+" AND stock.stockId=");
        saleLineDBFields[6] = new EntityDBFields("saleline","quantity","ποσότητα",0,"java.lang.Integer",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,null,fieldsCalculationQuantitySelect,"0");
       ...
       fieldsCalculationPriceSelect[0] = new EntityDBFieldsCalculation(FIELDSCALCULATION_CATEGORY_SAME,9,inputQuantityPriceCategory,inputQuantityPrice,"SELECT #*#");        
        saleLineDBFields[7] = new EntityDBFields("saleline","priceForOne","τιμή",0,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,null,fieldsCalculationPriceSelect,"0");
        ...
        saleLineDBFields[8] = new EntityDBFields("saleline","dbYearId","dbYearId",0,"java.lang.String",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,VariablesGlobal.globalYearId,"");
       ...
       //fieldsCalculationPriceBeforeVat[1] = new EntityDBFieldsCalculation(11,11,inputPreVatCategorySums,inputPreVatSums,"SELECT #");// for sums
        saleLineDBFields[9] = new EntityDBFields("saleline","priceBeforeVat","προ ΦΠΑ",0,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,null,fieldsCalculationPriceBeforeVatSelect,"");
       ...
       fieldsCalculationVatPercentValueSelect[0] = new EntityDBFieldsCalculation(FIELDSCALCULATION_CATEGORY_SAME,11,inputVatPercentCategory,inputVatPercentValue,"SELECT #*#/100");         
        saleLineDBFields[10] = new EntityDBFields("saleline","vatPercentage","ΦΠΑ %",0,"java.lang.Double",6,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,null,fieldsCalculationVatPercentValueSelect,"");
       ...
       fieldsCalculationVatValueSelect[0] = new EntityDBFieldsCalculation(FIELDSCALCULATION_CATEGORY_SAME,12,inputVatValueCategory,inputVatValue,"SELECT #+#");         
        saleLineDBFields[11] = new EntityDBFields("saleline","vatValue","αξία ΦΠΑ",0,"java.lang.Double",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,null,fieldsCalculationVatValueSelect,"");
       ...
       fieldsCalculationValueWithVatSelect[0] = new EntityDBFieldsCalculation(FIELDSCALCULATION_CATEGORY_SAME,7,inputValueWithVatCategory,inputValueWithVat,"SELECT #/(100+#)*100/#");         
        saleLineDBFields[12] = new EntityDBFields("saleline","valueWithVat","αξία",0,"java.lang.Double",9,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,null,fieldsCalculationValueWithVatSelect,"");                     
      ...
      //  saleDBFields[6] = new EntityDBFields("saleheader","dbYearId","dbYearId",0,"java.lang.String",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,VariablesGlobal.globalYearId,"");        
        ...
        saleDBFields[7] = new EntityDBFields("saleheader","traderId","συναλλασσόμενος",2,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"traderS", FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,null,fieldsCalculationTraderSelect,"");
   ...
   //     saleDBFields[18] = new EntityDBFields("saleheader","companyCurrencyDescr","νόμισμα εταιρίας",4,"java.lang.String",10,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null);        
    ...
    //    fieldsCalculationWithholdingTaxTotal[0] = new EntityDBFieldsCalculation(FIELDSCALCULATION_CATEGORY_SAME,19,inputWithholdingTaxRateTotalCategory,inputWithholdingTaxRateTotal,"SELECT # + #");                                
        ...
        serviceDBFields[1] = new EntityDBFields("stock","dbCompanyId","dbCompanyId",0,"java.lang.String",10,FIELD_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,VariablesGlobal.globalCompanyId,"");
        serviceDBFields[2] = new EntityDBFields("stock","code","κωδικός",0,"java.lang.String",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        serviceDBFields[3] = new EntityDBFields("stock","descr","ονομασία",0,"java.lang.String",33,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        serviceDBFields[4] = new EntityDBFields("stock","active","ενεργή",0,"java.lang.Boolean",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"true","");            
        serviceDBFields[5] = new EntityDBFields("stock","stockCatId","κατηγορία υπηρεσίας",0,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"stockcat", FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
...
*/                
       //----------------------------------------------service sales prefs below------------------
        ...
        companySetSerSalesDBFields[4] = new EntityDBFields("dbCompanySet","sersaleRetailTrader","προτεινόμενος συναλλασσόμενος λιανικής",2,"java.lang.Integer",4,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"traderS", FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,null,null,"");
...
*/        
  ...
  public void addEntityInfoNodes()
  {
     //------------------------------------------------------------
        ...
        saleErs[3]=new EntityFilterSettings("συναλλασσόμενος","","string","equals","title","traderS","saleheader","",-1,-1,-1,FIELD_NOCOMPLETION);
        saleErs[4]=new EntityFilterSettings("ΑΦΜ","","string","equals","vatNo","traderS","saleheader","",-1,-1,-1,FIELD_NOCOMPLETION);
   ...
   //----------------------------------------------------------------------      
      ...
      */ //EntityInfo ia = new EntityInfo("trader", "SELECT trader.traderId AS \"Νο συναλλασσόμενου\", trader.surname AS \"επίθετο\", trader.title AS \"όνομα\", trader.fathername AS \"πατρόνυμο\", trader.traderAfm AS \"Α.Φ.Μ.\", trader.doyId AS \"Νο Δ.Ο.Υ.\", doy.doyName AS \"ονομασία Δ.Ο.Υ.\", trader.idNo AS \"αρ ταυτοτ\", trader.phone AS \"τηλέφωνο(1)\", trader.phone2 AS \"τηλέφωνο(2)\", trader.phone3 AS \"τηλέφωνο(3)\", town.townName AS \"πόλη/χωριό\",town.postCode AS \"TK\", trader.address AS \"διεύθυνση\", bank.bankBranch AS \"τράπεζα\", trader.bankAccount AS \"λογαριασμός\" FROM trader LEFT JOIN doy ON trader.doyId=doy.doyId LEFT JOIN town ON trader.townId=town.townId LEFT JOIN bank ON trader.bankId=bank.bankId ORDER BY trader.surname, trader.title, trader.fathername, trader.traderAfm" ,"SELECT trader.traderId AS \"Νο συναλλασσόμενου\", trader.surname AS \"επίθετο\", trader.name AS\"όνομα\", trader.fathername AS \"πατρόνυμο\", trader.traderAfm AS \"Α.Φ.Μ.\", trader.doyId, trader.idNo AS \"αρ ταυτοτ\", trader.townId, trader.address AS \"διέυθυνση\", trader.phone AS\"τηλέφωνο\"","FROM trader LEFT JOIN doy ON trader.doyId=doy.doyId LEFT JOIN town ON trader.townId=town.townId","",null, fieldsForSumsTrader,null,null,traderDBFields,null,null,null,null,null,false,null,null ,"αγρότες","DORM","","Νο συναλλασσόμενου","traderId",null,null,traderErs,traderEntityGroupOfComps ,"αγρότη","αγροτών",null,null,strTraderCategories,entityPanelTrader,fieldsOnTitleTrader,fieldsOnTitleCaptionTrader,traderFieldsOrderBy,4,FIELD_VALIDATION_AFM,globalYearPlusOne); 
      ...
      /*  EntityMenu emia = new EntityMenu();
       ...
       //traderErs[0]=new EntityFilterSettings("επίθετο","","string","equals","surname","traderS",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
       traderErs[0]=new EntityFilterSettings("όνομα","","string","equals","title","traderS",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
       traderErs[1]=new EntityFilterSettings("ΑΦΜ","","string","equals","vatNo","traderS",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
       //traderErs[3]=new EntityFilterSettings("ταυτότητα","","string","equals","idNo","traderS",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
       //traderErs[4]=new EntityFilterSettings("πόλη/χωριό","checkboxTable","string","","townId","town","traderS","",-1,-1,-1,FIELD_NOCOMPLETION);
       traderErs[2]=new EntityFilterSettings("Δ.Ο.Υ.","checkboxTable","string","","doyId","doy","traderS","",-1,-1,-1,FIELD_NOCOMPLETION);
...
*/
       EntityFilterSettings[] traderErs = new EntityFilterSettings[3];      
       traderErs[0]=new EntityFilterSettings("κωδικός","","string","equals"," traderCode","traderS",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
       traderErs[1]=new EntityFilterSettings("επωνυμία","","string","equals","title","traderS",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
       traderErs[2]=new EntityFilterSettings("ΑΦΜ","","string","equals","vatNo","traderS",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
...
//      entities.add(entityLookUp = new EntityLookUp("trader1Col","trader","SELECT trader.traderId AS\"Νο συναλλασσόμενου\", traderCode AS\"κωδικός\", title AS\"επωνυμία\",  vatNo AS\"Α.Φ.Μ.\" FROM trader","WHERE trader.active LIKE 1",null,"AND trader.active LIKE 1", "ORDER BY trader.title","","traderId","Νο συναλλασσόμενου","traderId","συναλλασσόμενος",2,lookUpFieldtrader,"επωνυμία ή ΑΦΜ",29,"java.lang.String",0,null,null,0,null,null,traderQueryEditable, "συναλλασσόμενου","συναλλασομένων",strtraderCategories,entityPaneltrader,fieldsOnTitletrader,fieldsOnTitleCaptiontrader,traderErs,2,1,ICO_FARMER16,true,3,FIELD_VALIDATION_AFM,null));
   ...
   //-------------------------------------------------------------------------
     ...
     entities.add(entityLookUp = new EntityLookUp("stockcat","stockcat","SELECT stockCatId AS\"Νο κατηγορίας\", catDescr AS\"κατηγορία\", dbCompanyId FROM stockcat","WHERE dbCompanyId LIKE "+VariablesGlobal.globalCompanyId,null,"","ORDER BY catDescr","" ,"stockCatId","Νο κατηγορίας","stockCatId","κατηγορία",2,lookUpFieldServiceCat,"κατηγορία",15,"java.lang.String",0,null,null,0,null,null,serviceCatQueryEditable,"κατηγορία υπηρεσίας","κατηγοριών υπηρεσίας",null,entityPanelServiceCat,fieldsOnTitleServiceCat, fieldsOnTitleCaptionServiceCat,serviceCatErs,-1,1,null,true,-1,-1,null));
    ...
    {     
     ...
     // invoiceServiceErs[1]=new EntityFilterSettings("χρήση","onelookup","string","","dbYearId","dbyear","saleheader",VariablesGlobal.globalYearId,0,0,-1,FIELD_OBLIGATORY);
      invoiceServiceErs[0]=new EntityFilterSettings("χρήση","onelookup","string","","dbYearId","dbyear","saleheader", VariablesGlobal.globalYearId,0,-1,-1,FIELD_NOCOMPLETION);
       ...
       invoiceServiceErs[1]=new EntityFilterSettings("συναλλασσόμενος","checkboxTable","string","","traderId","traderS","trader","",1,-1,-1,FIELD_NOCOMPLETION);
     ...
     // salesErs[1]=new EntityFilterSettings("χρήση","onelookup","string","","dbYearId","dbyear","saleheader",VariablesGlobal.globalYearId,0,0,-1,FIELD_OBLIGATORY);
      salesErs[0]=new EntityFilterSettings("χρήση","onelookup","string","","dbYearId","dbyear","saleheader", VariablesGlobal.globalYearId,0,-1,-1,FIELD_NOCOMPLETION);
       ...
       salesErs[1]=new EntityFilterSettings("συναλλασσόμενος","checkboxTable","string","","traderId","traderS","trader","",1,-1,-1,FIELD_NOCOMPLETION);
...
//       EntityReportBand[] reportBandTraderServiceSaleDoc = new EntityReportBand[2];                                                                                                         //  EntityPanel[] entityPanelDrillIn,String[]  panelDrillFieldsOnTitleIn,String[]  panelDrillFieldsOnTitleCaptionIn
     ...
     // invoiceErs[1]=new EntityFilterSettings("χρήση","onelookup","string","","dbYearId","dbyear","saleheader",VariablesGlobal.globalYearId,0,0,-1,FIELD_OBLIGATORY);
      invoiceErs[0]=new EntityFilterSettings("χρήση","onelookup","string","","dbYearId","dbyear","saleheader", VariablesGlobal.globalYearId,0,-1,-1,FIELD_NOCOMPLETION);
       //invoiceErs[2]=new EntityFilterSettings("αποστολή","onelookup","string","equals","deliveryId","dbDelivery","a",VariablesGlobal.globalDeliveryId,0,-1,-1,FIELD_OBLIGATORY);        
       //invoiceErs[1]=new EntityFilterSettings("Νο συναλλασσόμενου","lookup","string","fromto","traderId","trader","traderS","",1,-1,-1,FIELD_NOCOMPLETION);
       invoiceErs[1]=new EntityFilterSettings("επίθετο","","string","equals","title","traderS",null,"",1,-1,-1,FIELD_NOCOMPLETION);
       invoiceErs[2]=new EntityFilterSettings("συναλλασσόμενος","checkboxTable","string","","traderId","traderS","trader","",1,-1,-1,FIELD_NOCOMPLETION);
       invoiceErs[3]=new EntityFilterSettings("ΑΦΜ","","string","equals","vatNo","traderS",null,"",1,-1,-1,FIELD_NOCOMPLETION);
       //invoiceErs[6]=new EntityFilterSettings("πόλη/χωριό","checkboxTable","string","","townId","town","f","",1,-1,-1,FIELD_NOCOMPLETION);
       //invoiceErs[7]=new EntityFilterSettings("Δ.Ο.Υ.","checkboxTable","string","","doyId","doy","f","",1,-1,-1,FIELD_NOCOMPLETION);
       invoiceErs[4]=new EntityFilterSettings("ημ/νία παραστατικού","","date","fromto","dateOfSale","saleheader",null,"",2,0,-1,FIELD_NOCOMPLETION);
      // invoiceErs[6]=new EntityFilterSettings("πλήθος παρ/κών","","double","fromto","invcount","d",null,"",2,-1,-1,FIELD_NOCOMPLETION);
       invoiceErs[5]=new EntityFilterSettings("τελικό ποσό","","double","fromto","priceTotal","saleheader",null,"",2,-1,-1,FIELD_NOCOMPLETION);
...
//       EntityFilterSettings[] invoiceErs = null;
 //      EntityGroupOfComps[] invoiceEntityGroupOfComps = null;
       ...
       traderErs[0]=new EntityFilterSettings("επίθετο","","string","equals","title","trader",null,"",0,-1,-1,FIELD_NOCOMPLETION);
       traderErs[1]=new EntityFilterSettings("αγρότης","checkboxTable","string","","traderId","trader","trader","",0,-1,-1,FIELD_NOCOMPLETION);
       traderErs[2]=new EntityFilterSettings("ΑΦΜ","","string","equals","vatNo","trader",null,"",0,-1,-1,FIELD_NOCOMPLETION);
       //invoiceErs[6]=new EntityFilterSettings("πόλη/χωριό","checkboxTable","string","","townId","town","f","",1,-1,-1,FIELD_NOCOMPLETION);
       //invoiceErs[7]=new EntityFilterSettings("Δ.Ο.Υ.","checkboxTable","string","","doyId","doy","f","",1,-1,-1,FIELD_NOCOMPLETION);
...
//-----        
 ...
 //      deliveryEntityReportGroup[1] = new EntityReportGroup("παραστατικά","SELECT i.aa AS\"α/α\", i.traderId,i.deliveryId,b.buyerTitle AS\"αγοραστής\", it.abbreviation  AS\"παρ/κο\", i.invoiceNo  AS\"αριθμός\",i.date  AS\"ημερομηνία\",i.dbyear, p.productName  AS\"προϊόν\", i.value  AS\"αξία\", i.valueReturn  AS\"επιστροφή\" FROM invoice i, trader f, application a, buyer b, product p, currency pt, paymentType it WHERE i.productId=p.productId AND pt.currencyId=p.currencyId AND b.buyerId=i.buyerId AND i.traderId = f.traderId AND a.traderId=f.traderId AND a.traderId=i.traderId AND a.dbyear=i.dbyear AND a.dbCompanyId=i.dbCompanyId AND a.deliveryId=i.deliveryId AND i.paymentTypeId=it.paymentTypeId","ORDER BY f.surname,f.name","appinvoice",ENTITYREPORT_QUERY_TYPE_MAIN,1,null,boolSettingsInvoice);  // many
      ...
      /* EntityFilterSettings[] deliveryErs = new EntityFilterSettings[5];       
       ...
       /*EntityFilterSettings[] invoiceeErs = new EntityFilterSettings[9];       
       ...
       invoiceeErs[0]=new EntityFilterSettings("αγρότης","checkboxTable","string","","traderId","trader","trader","",-1,-1,0,FIELD_NOCOMPLETION);
       invoiceeErs[1]=new EntityFilterSettings("επίθετο","","string","equals","surname","trader",null,"",-1,-1,0,FIELD_NOCOMPLETION);
       invoiceeErs[2]=new EntityFilterSettings("ΑΦΜ","","string","equals","traderAfm","trader",null,"",-1,-1,0,FIELD_NOCOMPLETION);
       invoiceeErs[3]=new EntityFilterSettings("πόλη/χωριό","checkboxTable","string","","townId","town","trader","",-1,-1,0,FIELD_NOCOMPLETION);
       invoiceeErs[4]=new EntityFilterSettings("Δ.Ο.Υ.","checkboxTable","string","","doyId","doy","trader","",-1,-1,0,FIELD_NOCOMPLETION);
       invoiceeErs[5]=new EntityFilterSettings("ημερομηνία παραστ.","","date","fromto","date","invoice",null,"",-1,-1,0,FIELD_NOCOMPLETION);
       invoiceeErs[6]=new EntityFilterSettings("αγοραστής","checkboxTable","string","","buyerId","buyer","invoice","",-1,-1,0,FIELD_NOCOMPLETION);
       invoiceeErs[7]=new EntityFilterSettings("προϊόν","checkboxTable","string","","productId","product","invoice","",-1,-1,0,FIELD_NOCOMPLETION);
       invoiceeErs[8]=new EntityFilterSettings("τύπος παραστατικού","checkboxTable","string","","paymentTypeId","paymentType","invoice","",-1,-1,0,FIELD_NOCOMPLETION);
       */
