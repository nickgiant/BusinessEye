...
public class EntityDataFarmersVat implements Constants 
{
 ...
 //       EntityPanel entityPanelFarmerBuyers = new EntityPanel("statFarmerBuyers","STATS",null,"αγοραστές",ICO_STATISTICS16,"SELECT frvbuyer.buyerId AS \"νο αγοραστή\", frvbuyer.title,frvbuyer.buyerAfm, COUNT(*) AS \"πλήθος\", SUM(frvapplicationline.value) AS \"σύνολο\"","FROM frvapplicationline, frvbuyer","WHERE frvapplicationline.buyerId = frvbuyer.buyerId AND frvapplicationline.farmerId=","GROUP BY frvbuyer.buyerId","ORDER BY frvbuyer.title",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear");
 //       EntityPanel entityPanelFarmerSalesPerDate = new EntityPanel("statFarmerSalesPerDate","STATS",null,"πωλήσεις ανα μήνα",ICO_STATISTICS16,"SELECT returnMonth(date, 'no') AS \"ΝΟ\", returnMonth(date, 'name') AS \"ΜΗΝΑΣ\" , COUNT(*)AS \"ΠΛΗΘΟΣ\", SUM(frvapplicationline.value) AS \"ΣΥΝΟΛΟ\", AVG(frvapplicationline.value) AS \"Μ.Ο.\"","FROM frvapplicationline","WHERE frvapplicationline.farmerId=","GROUP BY returnMonth(date, 'no'),returnMonth(date, 'name')","ORDER BY returnMonth(date, 'no')",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear");
   ...
   //     EntityGroupOfComps[] applicationLineGroupOfPanels = null;
        ...
        String[] fieldsOnTitleApplication ={"applicationHeaderId","title","name","farmerAfm","dateOfApplication"};
 ...
 //       EntityPanel entityPanelBuyerFarmers = new EntityPanel("statBuyerFarmers","STATS",null,"αγρότες",ICO_STATISTICS16,"SELECT frvfarmer.farmerId AS \"νο αγρότη\", frvfarmer.title, frvfarmer.name, frvfarmer.fatherName,frvfarmer.farmerAfm, COUNT(*) AS \"πλήθος\", SUM(frvapplicationline.value) AS \"σύνολο\"","FROM frvapplicationline, frvfarmer","WHERE frvapplicationline.farmerId = frvfarmer.farmerId AND frvapplicationline.buyerId=","GROUP BY frvfarmer.farmerId","ORDER BY frvfarmer.title, frvfarmer.name, frvfarmer.fatherName,frvfarmer.farmerAfm",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear");
 //       EntityPanel entityPanelBuyerBuysPerDate = new EntityPanel("statBuyerBuysPerDate","STATS",null,"πωλήσεις ανα μήνα",ICO_STATISTICS16,"SELECT returnMonth(date, 'no') AS \"ΝΟ\", returnMonth(date, 'name') AS \"ΜΗΝΑΣ\" , COUNT(*)AS \"ΠΛΗΘΟΣ\", SUM(frvapplicationline.value) AS \"ΣΥΝΟΛΟ\", AVG(frvapplicationline.value) AS \"Μ.Ο.\"","FROM frvapplicationline","WHERE frvapplicationline.buyerId=","GROUP BY returnMonth(date, 'no'),returnMonth(date, 'name')","ORDER BY returnMonth(date, 'no')",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear");
   ...
   //     String[] deliveryWhereValue ={"primKeyValue","globalCompanyId","globalDeliveryId","globalYear"};// global should contain global into their name (needed by panelOneDataOneRecData.checkIfNameIsWhereField)
       ...
       // EntityPanel[] entityPanelDelivery; // initialized in loadGenericData
        ...
        String[] fieldsOnTitleBuyer ={"buyerId","title","buyerAfm"};
 ...
 //       EntityPanel entityPanelBuyerBuysPerDate = new EntityPanel("statBuyerBuysPerDate","STATS",null,"πωλήσεις ανα μήνα",ICO_STATISTICS16,"SELECT returnMonth(date, 'no') AS \"ΝΟ\", returnMonth(date, 'name') AS \"ΜΗΝΑΣ\" , COUNT(*)AS \"ΠΛΗΘΟΣ\", SUM(frvapplicationline.value) AS \"ΣΥΝΟΛΟ\", AVG(frvapplicationline.value) AS \"Μ.Ο.\"","FROM frvapplicationline","WHERE frvapplicationline.buyerId=","GROUP BY returnMonth(date, 'no'),returnMonth(date, 'name')","ORDER BY returnMonth(date, 'no')",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear");
  ...
  //      EntityPanel entityPanelProductStatistics = new EntityPanel("statProductHistory","STATS",null,"ιστορικό",ICO_STATISTICS16,"SELECT dbyear AS \"χρήση\", dbcompany.title AS \"τίτλος συν/σμού\", frvapplicationline.deliveryId AS \"αποστολή\", COUNT(*) AS πλήθος, SUM(frvapplicationline.value) AS sum, AVG(frvapplicationline.value) AS average, MIN(frvapplicationline.value) AS min, MAX(frvapplicationline.value) AS max","FROM frvapplicationline, dbcompany","WHERE frvapplicationline.dbCompanyId = dbcompany.dbCompanyId AND frvapplicationline.productId=","GROUP BY dbyear, frvapplicationline.dbCompanyId, deliveryId","ORDER BY dbyear, dbcompany.title, frvapplicationline.deliveryId",false,"",false,"");
  //      EntityPanel entityPanelProductFarmers = new EntityPanel("statProductFarmers","STATS",null,"αγρότες",ICO_STATISTICS16,"SELECT frvfarmer.farmerId AS \"νο αγρότη\", frvfarmer.title, frvfarmer.name, frvfarmer.fatherName,frvfarmer.farmerAfm, COUNT(*) AS \"πλήθος\", SUM(frvapplicationline.value) AS \"σύνολο\"","FROM frvapplicationline, frvfarmer","WHERE frvapplicationline.farmerId = frvfarmer.farmerId AND frvapplicationline.productId=","GROUP BY frvfarmer.farmerId","ORDER BY frvfarmer.title, frvfarmer.name, frvfarmer.fatherName,frvfarmer.farmerAfm",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear");
  //      EntityPanel entityPanelProductBuyers = new EntityPanel("statProductBuyers","STATS",null,"αγοραστές",ICO_STATISTICS16,"SELECT frvbuyer.buyerId AS \"νο αγοραστή\", frvbuyer.title,frvbuyer.buyerAfm, COUNT(*) AS \"πλήθος\", SUM(frvapplicationline.value) AS \"σύνολο\"","FROM frvapplicationline, frvbuyer","WHERE frvapplicationline.buyerId = frvbuyer.buyerId AND frvapplicationline.productId=","GROUP BY frvbuyer.buyerId","ORDER BY frvbuyer.title",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear");
  //      EntityPanel entityPanelProductSalesPerDate = new EntityPanel("statProductSalesPerDate","STATS",null,"πωλήσεις ανα μήνα",ICO_STATISTICS16,"SELECT returnMonth(date, 'no') AS \"ΝΟ\",returnMonth(date, 'name') AS \"ΜΗΝΑΣ\" , COUNT(*)AS \"ΠΛΗΘΟΣ\", SUM(frvapplicationline.value) AS \"ΣΥΝΟΛΟ\", AVG(frvapplicationline.value) AS \"Μ.Ο.\"","FROM frvapplicationline","WHERE frvapplicationline.ProductId=","GROUP BY returnMonth(date, 'no'),returnMonth(date, 'name')","ORDER BY returnMonth(date, 'no')",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear");
      ...
      /*  EntityDBFields[] bankDBFields = new EntityDBFields[1];
       ...
       /* EntityDBFields[] dbCompanyDBFields = new EntityDBFields[13];        
        ...
        String dbCompanyQueryEditable="SELECT * FROM dbcompany";//SELECT dbcompany.dbCompanyId AS\"Νο εταιρίας\", dbcompany.title AS\"τίτλος\", dbcompany.companyVatNo AS\"Α.Φ.Μ.\", dbcompany.doyId, dbcompany.president ,dbcompany.townId,  dbcompany.bankId , dbcompany.bankAccount , dbcompany.bankAccountIBAN , dbcompany.notes FROM dbcompany";
...
*/
        ...
        farmerDBFields[1] = new EntityDBFields("frvfarmer","title","επίθετο",0,"java.lang.String",20, FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,  FIELD_VISIBLE_AND_EDITABLE,null,"");
   ...
   //    FIELD_PRIMARY_KEY
        ...
        buyerDBFields[1] = new EntityDBFields("frvbuyer","title","τίτλος αγοραστή",0,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
       ...
       /*	dbCompanyDBFields[0] = new EntityDBFields("dbcompany","dbCompanyId","Νο εταιρίας",0,"java.lang.Integer",4, FIELD_PRIMARY_KEY_AUTOINC,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
       	dbCompanyDBFields[1] = new EntityDBFields("dbcompany","title","τίτλος",0,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
 ...
 /*  	  intYearPlusOne = Integer.valueOf(VariablesGlobal.globalYear)+1;
   	...
   	deliveryQueryEditable = "SELECT a.farmerId, a.dateOfApplication, a.permanent, a.dbyear, a.deliveryId, a.dbCompanyId "
        ...
        deliveryQueryManyReadOnly = "SELECT i.aa AS \"αα\", i.farmerId, b.title AS\"αγοραστής\" ,it.abbreviation AS\"παρ\" ,applicationlineNo AS\"αρ παρ/κού\",date AS\"ημερομηνία\", p.productName AS\"προϊόν\" ,i.value AS\"αξία\", i.productTypePercentage AS\"ποσοστό\" , i.valueReturn AS\"επιστροφή\" "
...
*/        
  ...
  public void addEntityInfoNodes()
  {
       ...
       farmerErs[0]=new EntityFilterSettings("επίθετο","","string","equals","title","frvfarmer",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
    ...
    /*EntityFilterSettings[] deliveryErs = new EntityFilterSettings[8];       
       deliveryErs[0]=new EntityFilterSettings("επίθετο","","string","equals","title","f",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
      ...
      */ 
      ...
      /*  EntityMenu emic = new EntityMenu();
       ...
       deliveryBErs[1]=new EntityFilterSettings("επίθετο","","string","equals","title","f",null,"",0,-1,-1,FIELD_NOCOMPLETION);
...
//              " GROUP BY i.farmerId, i.deliveryId ORDER BY f.surname, f.name, f.fathername, f.farmerAfm,  i.deliveryId",null,null,null,deliveryQueryEditable,fieldsForSumsApplication,fieldsForSumsInvoice, "frvapplicationline","SELECT buyerId,applicationlineTypeId,applicationlineNo AS\"αρ παρ/κού\",date AS\"ημερομηνία\",productId,value AS\"αξία\" FROM frvapplicationline",applicationHeaderDBFields,applicationLineDBFields,/*deliveryFieldsManyOnInsert,deliveryFieldsManyTranslationOnInsert,*/"frvapplicationheader",deliveryQueryManyReadOnly,true, deliveryWhereField, deliveryWhereValue ,"παραστατικά αγροτών","DTRM","f"/*because in sql f is frvfarmer*/,"Νο αγρότη","farmerId",/*deliveryPrimKeyMany,deliveryPrimKeyManyTran ,*/deliveryBErs, deliveryEntityFilterGroupOfComps,"αγρότη με παραστατικά", "αγροτών με παραστατικά","το παραστατικό","παραστατικών", null,entityPanelDelivery,null,null,deliveryFieldsOrderBy,5,checkBoxInfo,entityTaskDelivery,4,FIELD_VALIDATION_AFM,globalYearPlusOne);
     ...
     /*          EntityFilterSettings[] entityFilterSettingsIn, EntityGroupOfComps[] entityGroupOfCompsIn,String strOfOneIn, String strOfManyIn, //String strOfOneIn2, String strOfManyIn2,
      ...
      EntityInfo id =  new EntityInfo("frvapplicationheader","SELECT frvapplicationheader.applicationHeaderId AS\"Νο αίτησης\" , f.farmerId AS\"Νο αγρότη\", f.title AS\"επίθετο\", f.name AS\"όνομα\", f.fatherName AS\"πατρόνυμο\",f.farmerAfm AS\"Α.Φ.Μ.\", permanent AS \"υπολ\" , frvapplicationheader.dateOfApplication AS \"ημ/νια αίτησης\",frvapplicationheader.dbYearDeliveryId AS \"αποστολή\", frvapplicationheader.invCount AS \"πλήθος\", frvapplicationheader.value AS \"αξία\",  frvapplicationheader.valueReturn AS \"επιστροφή\", frvapplicationheader.payment AS \"κράτηση\", (frvapplicationheader.valueReturn - frvapplicationheader.payment) AS \"σύνολο\""+
      ...
      //        " WHERE i.farmerId = f.farmerId AND a.farmerId = f.farmerId AND i.dbYearDeliveryId = a.dbYearDeliveryId AND a.dbYearDeliveryId = d.dbYearDeliveryId AND i.dbyear=a.dbyear AND i.dbCompanyId=a.dbCompanyId  " GROUP BY i.farmerId ORDER BY f.title, f.name, f.fathername",null,null,null,deliveryQueryEditable, "frvapplicationline","SELECT buyerId,applicationlineTypeId,applicationlineNo AS\"αρ παρ/κού\",date AS\"ημερομηνία\",productId,value AS\"αξία\" FROM frvapplicationline",applicationHeaderDBFields,applicationLineDBFields,deliveryFieldsManyOnInsert,deliveryFieldsManyTranslationOnInsert,"frvapplicationheader",deliveryQueryManyReadOnly,true, deliveryWhereField, deliveryWhereValue ,"παραστατικά αγροτών","DTRM","f","Νο αγρότη","farmerId",deliveryPrimKeyMany,deliveryPrimKeyManyTran ,deliveryBErs, deliveryEntityFilterGroupOfComps,"αγρότη με παραστατικά", "αγροτών με παραστατικά","το παραστατικό","παραστατικών", null,entityPanelDelivery,null,null,deliveryFieldsOrderBy,5,checkBoxInfo,entityTaskDelivery,4,FIELD_VALIDATION_AFM);
              ...
              " GROUP BY frvapplicationheader.applicationHeaderId ORDER BY f.title, f.name, f.fathername, f.farmerAfm,  frvapplicationheader.dbYearDeliveryId","SELECT frvapplicationheader.applicationHeaderId , f.farmerId AS\"Νο αγρότη\", f.title AS\"επίθετο\", f.name AS\"όνομα\", f.fatherName AS\"πατρόνυμο\",f.farmerAfm AS\"Α.Φ.Μ.\", permanent AS \"υπολ\" , frvapplicationheader.dateOfApplication AS \"ημ/νια αίτησης\",frvapplicationheader.dbYearDeliveryId AS \"αποστολή\", COUNT(i.value) AS \"πλήθος\", SUM(i.value) AS \"αξία\", SUM(retValueAccordingToType(1, i.productTypeId, i.valueReturn)) AS \"κατ 1\", SUM(retValueAccordingToType(2, i.productTypeId, i.valueReturn)) AS \"κατ 2\", SUM(retValueAccordingToType(3, i.productTypeId, i.valueReturn)) AS \"κατ 3\", frvapplicationheader.valueReturn AS \"επιστροφή\", frvapplicationheader.payment AS \"κράτηση\", (a.valueReturn - a.payment) AS \"σύνολο\""," FROM frvapplicationheader, frvfarmer f, frvapplicationline i, dbDelivery d ","",null,fieldsForSumsApplication,"παραστατικά αγροτών","DORM","","Νο αίτησης","applicationHeaderId",deliveryBErs,appicationEntityFilterGroupOfComps,"αγρότη με παραστατικά", "αγροτών με παραστατικά", strApplicationCategories,entityPanelApplication,fieldsOnTitleApplication, fieldsOnTitleCaptionApplication,applicationFieldsOrderBy,5,FIELD_VALIDATION_AFM,null,globalYearPlusOne);
...
//        listEntityInfo.add(id);
 ...
 String[] taskCalculationTypeCalc ={"υπολογισμός"};
     ...
     // eq[1] = new EntityQuery("UPDATE frvapplicationheader SET permanent=1",true,0,"success","faillure");
      ...
      eqNull[1] = new EntityQuery("UPDATE frvapplicationline AS i, frvapplicationheader AS a SET a.permanent =0, a.payment = NULL, a.valueReturn= NULL  WHERE a.dbCompanyId = "+VariablesGlobal.globalCompanyId,QUERY_UPDATE,null,null,null,"αιτήσεις ενημερώθηκαν.","Καμία αίτηση δεν ενημερώθηκε.");
 ...
 //       EntityInfoMany ib = new EntityInfoMany("frvapplicationheader", "SELECT f.farmerId AS\"Νο αγρότη\", f.surname AS\"επίθετο\", f.name AS\"όνομα\", f.fatherName AS\"πατρόνυμο\",f.farmerAfm AS\"Α.Φ.Μ.\", count(ri.value) AS\"πλήθος\",sum(ri.value) AS\"σύνολο\",sum(ri.total1) AS \"επισ 1\",sum(ri.total2) AS \"επισ 2\",sum(ri.total3) AS \"επισ 3\", sum(ri.total1)+sum(ri.total2)+sum(ri.total3) AS \"συν.επιστρ\" FROM return_from_applicationlines ri, frvfarmer f WHERE ri.farmerId = f.farmerId "/*AND ri.deliveryId = "+VariablesGlobal.globalDeliveryId+"*/+" AND ri.dbyear="+VariablesGlobal.globalYear+" AND ri.dbCompanyId="+VariablesGlobal.globalCompanyId+" GROUP BY f.farmerId ORDER BY f.surname, f.name",null,null,null,deliveryQueryEditable,null,null, "frvapplicationline",deliveryQueryManyEditable,applicationHeaderDBFields,applicationLineDBFields,/*deliveryFieldsManyOnInsert,deliveryFieldsManyTranslationOnInsert,*/"frvapplicationheader",deliveryQueryManyReadOnly,true, deliveryWhereField, deliveryWhereValue ,"παραστατικά αγρότη","DTRO","f"/*because in sql f is frvfarmer*/,"Νο αγρότη","farmerId",/*deliveryPrimKeyMany,deliveryPrimKeyManyTran ,*/null,null,"αγρότη με παραστατικά", "αγροτών με παραστατικά","το παραστατικό","παραστατικών", null,entityPanelDelivery,null,null,deliveryFieldsOrderBy,-1,null,entityTaskDelivery,4,FIELD_VALIDATION_AFM,globalYearPlusOne);
       ...
       buyerErs[0]=new EntityFilterSettings("επωνυμία","","string","equals","title","frvbuyer",null,"",-1,-1,-1,FIELD_NOCOMPLETION);
       ...
       //EntityInfo ie=new EntityInfo("frvbuyer", "SELECT frvbuyer.buyerId AS\"Νο αγοραστή\", frvbuyer.title AS \"τίτλος αγοραστή\", frvbuyer.buyerAfm AS \"Α.Φ.Μ.\", frvbuyer.doyId AS \"Νο Δ.Ο.Υ.\", doy.doyName AS \"ονομασία Δ.Ο.Υ.\", frvbuyer.phone AS \"τηλέφωνο(1)\",frvbuyer.phone2 AS \"τηλέφωνο(2)\", frvproduct.productName AS \"προτ. προϊόν\" FROM frvbuyer LEFT JOIN doy ON frvbuyer.doyId=doy.doyId LEFT JOIN frvproduct ON frvbuyer.productId=frvproduct.productId ORDER BY title "  ,"SELECT buyerId AS \"Νο αγοραστή\", title AS \"τίτλος αγοραστή\", buyerAfm AS \"Α.Φ.Μ.\", doyId"," FROM frvbuyer","",null,fieldsForSumsBuyer,null,null,buyerDBFields,null,null,null,null,null,false,null,null ,"αγοραστές","DORM","","Νο αγοραστή","buyerId",null,null,buyerErs,buyerEntityGroupOfComps,"αγοραστή","αγοραστών",null, null, strBuyerCategories,entityPanelBuyer,fieldsOnTitleBuyer, fieldsOnTitleCaptionBuyer,buyerFieldsOrderBy,2,FIELD_VALIDATION_AFM,globalYearPlusOne);
...
/*        EntityTask ta = new EntityTask("permanent","υπολογισμός επιστροφής και κρατήσεων", "υπολογισμός επιστροφής και κρατήσεων", taskCalculationTypeCalc, taskErs,taskEntityGroupOfComps,eqCalc,false,"d" );
   ...
   { 
     ...
     String[] lookUpFieldFarmer={"title","farmerAfm"};
     ...
     //int[] lookUpFieldIndexInvoiceType ={2,3,0};     
     String[] lookUpFieldBuyer={"buyerId","title","buyerAfm"};     
     ...
     entities.add(entityLookUp = new EntityLookUp("frvproduct","frvproduct","SELECT frvproduct.productId AS\"Νο προϊόντος\", frvproduct.productName AS \"ονομασία\", frvproduct.productTypeId AS \"Νο τύπου\", frvproducttype.producttypeName AS \"τύπος προϊόντος\", frvproducttype.returnVat AS \"επιστρ φόρου\", frvproducttype.returnFuel AS \"επιστρ πετρελαίου\"  FROM frvproduct, frvproducttype"," WHERE frvproduct.productTypeId = frvproducttype.productTypeId",null,"","ORDER BY frvproduct.productName ",""/*queryWhereForFormVariable*/,"productId","Νο προϊόντος","productId","ονομασία προϊόντος",2,lookUpFieldProduct,"ονομασία",15,"java.lang.String",0,null,null,0,null,null,productQueryEditable,"προϊόντος","προϊόντων",null,entityPanelProduct,fieldsOnTitleProduct,fieldsOnTitleCaptionProduct,productErs,2,1,null,true,-1,-1,null));    	 	
     ...
     //------------------------------------------------------------
      ...
      /*  EntityFilterSettings[] doyErs = new EntityFilterSettings[2];       
       ...
       dbCompanyErs[2]=new EntityFilterSettings("Δ.Ο.Υ.","checkboxTable","string","","doyId","doy","dbcompany","",-1,-1,-1,FIELD_NOCOMPLETION);
        ...
        EntityParameter pg = new EntityParameter("dbcompany", "SELECT dbcompany.dbCompanyId AS\"Νο εταιρίας\", dbcompany.title AS\"τίτλος\", dbcompany.companyVatNo AS\"Α.Φ.Μ.\", dbcompany.doyId AS\"Νο Δ.Ο.Υ.\" ,doy.doyname AS\"ονομασία Δ.Ο.Υ.\",  active, bank.bankBranch AS\"τράπεζα\",dbcompany.bankAccount AS\"λογαριασμός τραπεζας\",dbcompany.bankAccountIBAN AS\"ΙΒΑΝ\" FROM dbcompany LEFT JOIN doy ON dbcompany.doyId=doy.doyId LEFT JOIN bank ON dbcompany.bankId=bank.bankId ORDER BY dbcompany.title"  ,"SELECT dbcompany.dbCompanyId AS\"Νο εταιρίας\", dbcompany.title AS\"τίτλος\", dbcompany.companyVatNo AS\"Α.Φ.Μ.\", dbcompany.doyId,  dbcompany.bank , dbcompany.bankAccount , dbcompany.bankAccountIBAN, dbcompany.notes" ," FROM dbcompany" ,"",fieldsForSumsDbCompany,dbCompanyDBFields ,"εταιρίες","DORM","Νο εταιρίας","dbCompanyId",dbCompanyErs,null,"εταιρίας", "εταιριών",entityPanelDbCompany,null,fieldsOnTitleDbCompany,fieldsOnTitleCaptionDbCompany,companyFieldsOrderby,2,FIELD_VALIDATION_AFM,globalYearPlusOne);
       ...
       */
        ...
        String[] fieldsForSumsDbYear=null;                                     //  , dbyear.dbcompanyid AS\"Νο εταιρίας\"  ,dbcompany.title AS\"εταιρία\"      , dbcompany        dbyear.dbCompanyId=dbcompany.dbCompanyId AND 
   ...
   */      
       ...
       applicationlineErs[4]=new EntityFilterSettings("επίθετο","","string","equals","title","frvfarmer",null,"",1,-1,-1,FIELD_NOCOMPLETION);
       ...
       */
       ...
       //applicationlineEntQuery[0]= new EntityQuery("SELECT frvfarmer.farmerId,frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name,frvapplicationline.* FROM frvapplicationline, frvfarmer, frvapplicationheader WHERE frvapplicationheader.farmerId = frvfarmer.farmerId AND frvapplicationline.farmerId = frvfarmer.farmerId",false,0,null,null,null,null,null);
  
       //EntityQuery[] deliveryCheckEntQuery = new EntityQuery[1]; 
       //deliveryCheckEntQuery[0]= new EntityQuery("SELECT frvapplicationline.farmerId,frvbuyer.title , frvapplicationline.applicationlineTypeId,frvapplicationline.applicationlineNo,frvapplicationline.date,frvapplicationline.dbyear, frvapplicationline.productId, frvapplicationline.value, frvapplicationline.valueReturn FROM frvapplicationline, frvfarmer, frvapplicationheader, frvbuyer WHERE frvbuyer.buyerId=frvapplicationline.buyerId AND frvapplicationline.farmerId = frvfarmer.farmerId AND frvapplicationheader.farmerId=frvfarmer.farmerId AND frvapplicationheader.farmerId=frvapplicationline.farmerId ORDER BY frvfarmer.title,frvfarmer.name",false,0,null,null,null,null,null);
        
       // same as entityInfoMany the read only of list
       //String deliveryCheckHeaderEntQuery="SELECT f.farmerId AS\"Νο αγρότη\", f.title AS\"επίθετο\", f.name AS\"όνομα\", f.fatherName AS\"πατρόνυμο\",f.farmerAfm AS\"Α.Φ.Μ.\", permanent AS \"υπολ\" , d.dateOfApplication AS \"ημ/νια αίτησης\" , COUNT(i.value) AS \"πλήθος\", SUM(i.value) AS \"αξία\", SUM(retValueAccordingToType(1, i.productTypeId, i.valueReturn)) AS \"κατ 1\", SUM(retValueAccordingToType(2, i.productTypeId, i.valueReturn)) AS \"κατ 2\", SUM(retValueAccordingToType(3, i.productTypeId, i.valueReturn)) AS \"κατ 3\", d.valueReturn AS \"συν επιστρ\", d.payment AS \"κράτηση\" FROM frvapplicationheader d, frvfarmer f, frvapplicationline i WHERE i.farmerId = f.farmerId AND d.farmerId = f.farmerId AND i.deliveryId = d.deliveryId AND i.dbyear=d.dbyear AND i.dbCompanyId=d.dbCompanyId GROUP BY f.farmerId, d.permanent, d.dateOfApplication ORDER BY f.title, f.name";
       ...
       erbfFarmer[2]=new EntityReportBandField("frvfarmer","title","title","java.lang.String",35,true,"",null);
...
//---------------------------------------------------------
       ...
       controlErs[4]=new EntityFilterSettings("επίθετο","","string","equals","title","frvfarmer",null,"",1,-1,-1,FIELD_NOCOMPLETION);
       ...
       */
       ...
       erbfApplicationHeaderCtrl[5]=new EntityReportBandField("frvfarmer","title","επίθετο","java.lang.String",30,true,"",null);
       ...
       erbfFarmerCtrl[2]=new EntityReportBandField("frvfarmer","title","title","java.lang.String",35,true,"",null);
    ...
    /*   EntityQuery[] retPerTownEntityQuery = new EntityQuery[1];
       retPerTownEntityQuery[0]= new EntityQuery("SELECT k.farmerId, k.title, k.name, k.farmerAfm, k.townId, k.doyId, COUNT(farmerId),SUM(value) FROM (SELECT frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name, frvfarmer.townId, frvtown.townName, frvfarmer.doyId, frvapplicationline.* FROM frvapplicationline,"+
...
//------------------------------------------------------------        
       ...
       paymentErs[4]=new EntityFilterSettings("επίθετο","","string","equals","title","frvfarmer",null,"",1,-1,0,FIELD_NOCOMPLETION);
       ...
       erbFields[1]=new EntityReportBandField("frvfarmer","title","title","java.lang.String",25,true,"",null);
       ...
       //invEntityQuery[0]= new EntityQuery("SELECT frvfarmer.farmerId,frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name, frvfarmer.fathername, COUNT(frvapplicationline.value), SUM(frvapplicationline.value),  SUM(retValueAccordingToType(1, frvapplicationline.productTypeId, frvapplicationline.valueReturn)) AS \"κατ 1\", SUM(retValueAccordingToType(2, frvapplicationline.productTypeId, frvapplicationline.valueReturn)) AS \"κατ 2\", SUM(retValueAccordingToType(3, frvapplicationline.productTypeId, frvapplicationline.valueReturn)) AS \"κατ 3\",  frvapplicationheader.valueReturn AS \"συν επιστρ\" FROM frvapplicationline, frvfarmer, frvapplicationheader"+
...
/*
  ...
  /*     EntityReportGroup[] paymentEntityReportGroup = new EntityReportGroup[1];
       paymentEntityReportGroup[0] = new EntityReportGroup("αγρότες","SELECT frvfarmer.farmerId, frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name, bank.bankBranch AS \"τράπεζα\", frvfarmer.bankAccount AS \"λογαριασμός\", frvapplicationheader.invcount AS \"πληθ παρ\", frvapplicationheader.value AS \"αξία\",  frvapplicationheader.valueReturn AS \"επιστροφή\", frvapplicationheader.payment AS \"κράτηση\",frvapplicationheader.valueReturn - frvapplicationheader.payment AS \"σύνολο\", frvapplicationheader.signature AS \"υπογραφή\"     FROM frvfarmer LEFT JOIN bank ON bank.bankId=frvfarmer.bankId LEFT JOIN frvapplicationheader ON frvfarmer.farmerId=frvapplicationheader.farmerId"+
...
//        emrc.setEntityReport(rc,ICO_PRINT_PREVIEW16);
       ...
       deliveryErs[1]=new EntityFilterSettings("επίθετο","","string","equals","title","frvfarmer",null,"",-1,-1,1,FIELD_NOCOMPLETION);
  ...
  //     retPerTownEntityReportGroup[0] = new EntityReportGroup("πόλεις/χωριά","SELECT townId, townName FROM frvtown","","frvtown",ENTITYREPORT_QUERY_TYPE_MAIN,0,"townId",boolSettingsTown); 
   //    retPerTownEntityReportGroup[1] = new EntityReportGroup("αγρότες","SELECT k.farmerId, k.title, k.name, k.farmerAfm, k.townId, k.doyId, COUNT(farmerId),SUM(value) FROM (SELECT frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name, frvfarmer.townId, frvtown.townName, frvfarmer.doyId, frvapplicationline.* FROM frvapplicationline,"+
   //    "frvfarmer, frvtown WHERE frvapplicationline.farmerId = frvfarmer.farmerId AND frvtown.townId = frvfarmer.townId AND dbyear="+VariablesGlobal.globalYear+" AND deliveryId = "+VariablesGlobal.globalDeliveryId+
...
*/
       ...
       applicationlineeErs[2]=new EntityFilterSettings("επίθετο","","string","equals","title","frvfarmer",null,"",-1,-1,0,FIELD_NOCOMPLETION);
       ...
       //retFarmerEntityQuery[0]= new EntityQuery("SELECT frvfarmer.farmerId,frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name,frvapplicationline.dbyear,frvapplicationline.value,frvapplicationline.valueReturn FROM frvapplicationline, "+
   ...
   //    retFarmerEntityReportGroup[0] = new EntityReportGroup("παραστατικά","SELECT frvfarmer.farmerId,frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name,frvapplicationline.dbyear,frvapplicationline.value,frvapplicationline.valueReturn FROM frvapplicationline, "+
 ...
 */      
      /* boolean[] applicationlinesSelectedTDMR ={true,true,true,true,true,false,false,false,false,false,false,false,true,false,true,};
       base = new DefaultMutableTreeNode(new EntityReport("frvapplicationline","frvtown","SELECT frvfarmer.farmerId,frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name,frvtown.townId, frvapplicationline.* FROM frvapplicationline, "+
       ...
       */
       ...
       //retInvoiceSumEntityQuery[0]= new EntityQuery("SELECT k.farmerId,k.title, k.name, k.farmerAfm, COUNT(farmerId) AS count ,SUM(value) AS sum FROM (SELECT frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name, frvapplicationline.* FROM frvapplicationline,"+
   ...
   //    retInvoiceSumEntityReportGroup[0] = new EntityReportGroup("παραστατικά","SELECT k.farmerId,k.title, k.name, k.farmerAfm, COUNT(farmerId) AS count ,SUM(value) AS sum FROM (SELECT frvfarmer.farmerAfm, frvfarmer.title,frvfarmer.name, frvapplicationline.* FROM frvapplicationline,"+
   //    "frvfarmer WHERE frvapplicationline.farmerId = frvfarmer.farmerId AND dbyear="+VariablesGlobal.globalYear+" AND deliveryId = "+VariablesGlobal.globalDeliveryId+
...
*/
       ...
       applicationheaderFormErs[4]=new EntityFilterSettings("επίθετο","","string","equals","title","frvfarmer",null,"",1,-1,-1,FIELD_NOCOMPLETION);
    ...
    EntityReportBandField[] erbfApplicationLine = new EntityReportBandField[8];
      ...
      EntityReportBandField[] erbFieldsAppForm = new EntityReportBandField[13];
       ...
       erbFieldsAppForm[1]=new EntityReportBandField("frvfarmer","title","title","java.lang.String",35,true,"",null);
...
//    old version    EntityReport ri = new EntityReport("farmerapp",REPORT_CAT_APPLICATIONS,applicationheaderEntityReportGroup,"FORM","αιτήσεις παραγωγών-έντυπα","",applicationheaderFormErs,applicationheaderFormEntityGroupOfComps,applicationlinesSelected, null, applicationheaderOrderBy,intSettingsReportFarmerapp,boolSettingsReportFarmerapp,globalYearPlusOne) ;
        EntityReport ri = new EntityReport("farmerapp",REPORT_CAT_APPLICATIONS,applicationheaderEntityReportBand,"SELECT *  FROM frvfarmer , frvapplicationheader, frvapplicationline, frvproduct, frvbuyer, frvinvoicetype WHERE frvapplicationheader.farmerId = frvfarmer.farmerId AND frvapplicationheader.applicationHeaderId = frvapplicationline.applicationHeaderId AND frvproduct.productId = frvapplicationline.productId AND frvbuyer.buyerId = frvapplicationline.buyerId AND frvinvoicetype.invoicetypeId = frvapplicationline.invoicetypeId",""/*ORDER BY frvapplicationheader.applicationheaderId"*/,"FORM","αιτήσεις παραγωγών-έντυπα","subtitle",applicationheaderFormErs,applicationheaderFormEntityGroupOfComps,applicationlinesSelected, null,
  ...
  public void addStatisticsNodes() 
  {
      ...
      // scoreErs[2]=new EntityFilterSettings("αποστολή","checkboxTable","string","equals","dbYearDeliveryId","frvyeardelivery","frvapplicationline","",0,-1,-1,FIELD_NOCOMPLETION); 
       ...
       EntityGroupOfComps[] entityGroupOfComps = null;
        ...
        sa[0] = new EntityStatistics("statInvoicespercompany","dbcompany","παραστατικά ανα εταιρία","SELECT dbcompany.dbCompanyId, dbcompany.title, COUNT(frvapplicationline.dateinv) AS count, SUM(frvapplicationline.value) AS sum, SUM(frvapplicationline.valueReturn) AS sumret, AVG(frvapplicationline.value) AS average","FROM dbcompany, frvapplicationline","WHERE dbcompany.dbCompanyId=frvapplicationline.dbCompanyId","GROUP BY dbcompany.dbCompanyId","ORDER BY dbcompany.title",false,null,true,"frvapplicationline.dbyear","dbCompanyId","dbCompanyId",null,null,null);                                                   																																																																																//boolean isFilterCompanyIn, String fielddbCcompanyIdNameIn, boolean isFilterYearIn,String fieldYearNameIn)
        ...
        //EntityStatistics sa = new EntityStatistics("applicationlinespercompany","dbcompany","παραστατικά ανα εταιρία","SELECT dbcompany.dbCompanyId, dbcompany.title, COUNT(frvapplicationline.dateinv) AS count, SUM(frvapplicationline.value) AS sum, SUM(frvapplicationline.returnValue) AS sumret, AVG(frvapplicationline.value) AS average","FROM dbcompany, frvapplicationline","WHERE dbcompany.dbCompanyId=frvapplicationline.dbCompanyId","GROUP BY dbcompany.dbCompanyId","ORDER BY dbcompany.title",false,null,true,"frvapplicationline.dbyear","dbCompanyId","dbCompanyId");                                                     																																																																																//boolean isFilterCompanyIn, String fielddbCcompanyIdNameIn, boolean isFilterYearIn,String fieldYearNameIn)																								
        ...
        sd[0] = new EntityStatistics("statSumsofbuyers","frvbuyer","ποσά αγοραστών","SELECT frvbuyer.buyerId, frvbuyer.title, COUNT(frvapplicationline.buyerId) AS count, SUM(frvapplicationline.value) AS sum,SUM(frvapplicationline.valueReturn) AS sumret, AVG(frvapplicationline.value) AS average","FROM frvbuyer, frvapplicationline","WHERE frvbuyer.buyerId=frvapplicationline.buyerId","GROUP BY frvbuyer.buyerId","ORDER BY frvbuyer.title",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear","buyerId","buyerId",null,null,null);
        ...
        //EntityStatistics sc = new EntityStatistics("sumsofbuyers","frvbuyer","ποσά αγοραστών","SELECT frvbuyer.buyerId, frvbuyer.title, COUNT(frvapplicationline.buyerId) AS count, SUM(frvapplicationline.value) AS sum,SUM(frvapplicationline.returnValue) AS sumret, AVG(frvapplicationline.value) AS average","FROM frvbuyer, frvapplicationline","WHERE frvbuyer.buyerId=frvapplicationline.buyerId","GROUP BY frvbuyer.buyerId","ORDER BY frvbuyer.title",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear","buyerId","buyerId");
        ...
        sf[0] = new EntityStatistics("statSumsoffarmers","frvfarmer","ποσά αγροτών","SELECT frvfarmer.farmerId, frvfarmer.title,frvfarmer.name, frvfarmer.fatherName, COUNT(frvapplicationline.farmerId) AS count, SUM(frvapplicationline.value) AS sum,SUM(frvapplicationline.valueReturn) AS sumret, AVG(frvapplicationline.value) AS average","FROM frvfarmer, frvapplicationline","WHERE frvfarmer.farmerId=frvapplicationline.farmerId","GROUP BY frvfarmer.farmerId","ORDER BY frvfarmer.title, frvfarmer.name, frvfarmer.fatherName",true,"frvapplicationline.dbCompanyId",true,"frvapplicationline.dbyear","farmerId","farmerId",null,null,null);
