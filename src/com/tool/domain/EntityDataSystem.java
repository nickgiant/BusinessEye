...
public class EntityDataSystem extends EntityData implements Constants 
{
   ...
   /*     EntityDBFields[] serviceCatDBFields = new EntityDBFields[2];
     ...
     */   
     ...
     EntityDBFields[] dbUserRolesDBFields = new EntityDBFields[3]; 
...
//dbyearDBFields[3] = new EntityDBFields("dbyear","yearDelivery","αποστολές του έτους",1,"table",FIELD_VISIBLE_AND_EDITABLE,"dbYearDelivery",200,CHILDTABLEINPOSITION_INSIDE_EACH_DATAFIELD_PANEL,dbYearDeliveryDBFields,FIELD_TABLE_ONEROWATLEAST_OBLIGATORY,"SELECT dbYearDeliveryId, dbYearId,aa,description,dbCompanyId FROM dbYearDelivery WHERE dbCompanyId LIKE "+VariablesGlobal.globalCompanyId+"  ORDER BY aa",null);
        ...
        updateAdditionalDbCompany[0] = new EntityUpdateAdditional(UPDATE_ON_INSERT_ONLY,UPDATEADDITIONAL_ENABLED,null,null,null,"INSERT INTO dbcompanyset (`dbCompanyId`, `sersaleCodeOfDocumentsLength`, `sersaleWithHoldingTaxAmountGreaterThan`, `sersaleWithHoldingTaxRate`, `sersaleCheckAFMOfSaleAndComp`, `sersaleCopyCustomerNameToSaleComment`, `esoexoCheckAFMOfEsoExoAndComp`,`esoexoCopyTraderNameToEsoexoComment`,"
                + " esoexoMaxOfCashCheck, esoexoMaxOfCashNetValue, esoexoIsReadOnlyOnOtherSource ) VALUES ('#', '7', '300', '20','1','1','1','1','1',500, 1) " ,updateQueryFieldsCompany,null,null,null);
        ...
        dbCompanyDBFields[6] = new EntityDBFields("dbcompany","dateEstablished","ημερομηνία έναρξης",0,"java.sql.Date",12,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        dbCompanyDBFields[7] = new EntityDBFields("dbcompany","active","ενεργή",0,"java.lang.Boolean",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"true","");
        dbCompanyDBFields[8] = new EntityDBFields("dbcompany","activityCatId","κατηγορία δραστηριότητας",0,"java.lang.Integer",3,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"activityCat",FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
        dbCompanyDBFields[9] = new EntityDBFields("dbcompany","typeOfVatId","κατηγορία ΦΠΑ",0,"java.lang.Integer",3,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
       	dbCompanyDBFields[10] = new EntityDBFields("dbcompany","currencyId","νόμισμα",0,"java.lang.Integer",3,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"currency",FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
       	dbCompanyDBFields[11] = new EntityDBFields("dbcompany","participatesInPayroll","συμμετέχει στη μισθoδοσία;",0,"java.lang.Boolean",2,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"true","");
        
        dbCompanyDBFields[12] = new EntityDBFields("dbcompany","addressCity","πόλη/χωριό",1,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        dbCompanyDBFields[13] = new EntityDBFields("dbcompany","addressStreet","οδός",1,"java.lang.String",35,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        dbCompanyDBFields[14] = new EntityDBFields("dbcompany","addressPC","ΤΚ",1,"java.lang.String",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        dbCompanyDBFields[15] = new EntityDBFields("dbcompany","addressState","νομός",1,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        
        dbCompanyDBFields[16] = new EntityDBFields("dbcompany","bankId","τράπεζα",2,"java.lang.Integer",3,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"bank",FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
       	dbCompanyDBFields[17] = new EntityDBFields("dbcompany","bankAccount","λογαριασμός",2,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
       	dbCompanyDBFields[18] = new EntityDBFields("dbcompany","bankAccountIBAN","ΙΒΑΝ",2,"java.lang.String",35,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        
        
        dbCompanyDBFields[19] = new EntityDBFields("dbcompany","notes","σημειώσεις",3,"java.lang.String",220,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        
        dbCompanyDBFields[20] = new EntityDBFields("dbcompany","message","μήνυμα",4,"java.lang.String",100,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
        ...
        dbCompanyDBFields[21] = new EntityDBFields("dbcompany","charOfDecimal","χαρακτήρας δεκαδικών",5,"java.lang.String",1,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_TABLECONSTANTS,"LTCdecimalchar",FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,",","");
        ...
        dbCompanyDBFields[22] = new EntityDBFields("dbcompany","lengthOfDecimalPrice","μήκος δεκαδικών αξίας",5,"java.lang.Integer",3,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"2","");                
        String[] selectQueryFieldsCompany ={"dbCompanyId"};
        dbCompanyDBFields[23] = new EntityDBFields("dbcompany","dbyear","χρήσεις",6,"table",FIELD_VISIBLE_AND_EDITABLE,"dbyear",130,CHILDTABLEINPOSITION_BORDER_LAYOUT_CENTER_SIZABLE,dbyearLineDBFields,FIELD_TABLE_ONEROWATLEAST_OBLIGATORY,"SELECT * FROM dbyear WHERE dbCompanyId = # ORDER BY dbyearId",selectQueryFieldsCompany,null,null,null);     //String[] childTableFieldsForSumsIn   
        
        dbCompanyDBFields[24] = new EntityDBFields("dbcompany","afmTaxisUsername","χρήστης",7,"java.lang.String",25,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        dbCompanyDBFields[25] = new EntityDBFields("dbcompany","afmTaxisPassword","κωδικός",7,"java.lang.String",25,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        ...
        dbCompanyEntityGroupOfComps[3]= new EntityGroupOfComps("σημειώσεις",1,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
        dbCompanyEntityGroupOfComps[4]= new EntityGroupOfComps("μήνυμα",2,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
        ...
        dbCompanyEntityGroupOfComps[6] = new EntityGroupOfComps("χρήσεις (Χρειάζεται να εισέλθετε ξανα στην εφαρμογή για να εφαρμοσθούν οι αλλαγές.)",4,1,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
        ...
        dbuserDBFields[6] = new EntityDBFields("dbUser","userRoleId","ρόλος",0,"java.lang.Integer",4,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"dbuserrole",FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        
        //dbuserDBFields[4] = new EntityDBFields("dbCompanyId","Νο εταιρίας",0, FIELD_SUGGEST,FIELD_VALIDATION_NO);
        dbuserEntityGroupOfComps[0]= new EntityGroupOfComps("βασικά",4,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
        ...
        dbUserRolesDBFields[1] = new EntityDBFields("dbUserRole","roleDescr","περιγραφή",0,"java.lang.String",40,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
        dbUserRolesDBFields[2] = new EntityDBFields("dbUserRole","isAccountant","είναι λογιστής;",0,"java.lang.String",6,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_TABLECONSTANTS,"LTCIsUserAcc",FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"3","");
...
//-------------------------        
    ...
    //----------------------------------------------        
   	...
   	activityCatLineDBFields[0] = new EntityDBFields("activitycat","activityCatId","Νο δραστηριότητας",0,"java.lang.Integer",3, FIELD_PRIMARY_KEY_AUTOINC,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,"");
        ...
        vatCatDBFields[0] = new EntityDBFields("vatcatheader","vatcat","κατηγορίες ΦΠΑ",0,"table",FIELD_VISIBLE_AND_EDITABLE,"vatcat",130,CHILDTABLEINPOSITION_BORDER_LAYOUT_CENTER_SIZABLE,vatCatLineDBFields,FIELD_TABLE_NOROWCOMPLETION,"SELECT * FROM vatcat ORDER BY vatCatId",null,null,null,null);     //String[] childTableFieldsForSumsIn   
       ...
       // parameterEntityGroupOfComps[3]= new EntityGroupOfComps("μορφή ημερομηνίας",4,0); 
        ...
        doyDBFields[0] = new EntityDBFields("doyheader","doy","ΔΟΥ",0,"table",FIELD_VISIBLE_AND_EDITABLE,"doy",130,CHILDTABLEINPOSITION_BORDER_LAYOUT_CENTER_SIZABLE,doyLineDBFields,FIELD_TABLE_NOROWCOMPLETION,"SELECT doyId AS \"Νο Δ.Ο.Υ.\", doyName AS \"ονομασία\", address AS \"διεύθυνση\", town AS \"πόλη/χωριό\", pc AS \"ΤΚ\", tel1 AS \"τηλ 1\", tel2 AS \"τηλ 2\", fax AS \"φαξ\" FROM doy ORDER BY doyId",null,null,null,null);     //String[] childTableFieldsForSumsIn   
        ...
        bankDBFields[0] = new EntityDBFields("bankheader","bank","τράπεζες",0,"table",FIELD_VISIBLE_AND_EDITABLE,"bank",130,CHILDTABLEINPOSITION_BORDER_LAYOUT_CENTER_SIZABLE,bankLineDBFields,FIELD_TABLE_NOROWCOMPLETION,"SELECT bankId AS \"Νο τράπεζας\", bankBranch AS \"ονομασία τράπεζας\", bic AS \"BIC\" FROM bank ORDER BY bankId",null,null,null,null);     //String[] childTableFieldsForSumsIn   
    ...
    /*    companySetSerSalesDBFields[0] = new EntityDBFields("dbCompanySet","dbCompanyId","Νο εταιρίας",0,"java.lang.Integer",4, FIELD_PRIMARY_KEY_AUTOINC,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,VariablesGlobal.globalCompanyId);
        ...
        actionTypeCopyDBFields[1] = new EntityDBFields("actiontypecopy","dbCompanyId","dbCompanyId",0,"java.lang.String",10,FIELD_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,VariablesGlobal.globalCompanyId,"");
        actionTypeCopyDBFields[2] = new EntityDBFields("actiontypecopy","actionTypeId","actionTypeId",0,"java.lang.String",15, FIELD_PRIMARY_KEY_FROM_PARENTTABLE,LOOKUPTYPE_NOLOOKUP,null,FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,null,"");
        actionTypeCopyDBFields[3] = new EntityDBFields("actiontypecopy","copyNo","νο αντίγραφου",0,"java.lang.Integer",15,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null, FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        actionTypeCopyDBFields[4] = new EntityDBFields("actiontypecopy","textToPrint","κείμενο αντίγραφου",0,"java.lang.String",40,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
        
        
        actionTypeDBFields[0] = new EntityDBFields("actiontype","actionTypeId","Νο τύπου παραστατικού",0,"java.lang.Integer",3, FIELD_PRIMARY_KEY_AUTOINC,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,""); 
        actionTypeDBFields[1] = new EntityDBFields("actiontype","dbCompanyId","dbCompanyId",0,"java.lang.String",10,FIELD_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,VariablesGlobal.globalCompanyId,"");
         actionTypeDBFields[2] = new EntityDBFields("actiontype","actionTypeDescription","ονομασία",0,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         actionTypeDBFields[3] = new EntityDBFields("actiontype","actionTypeCode","κωδικός παραστατικού",0,"java.lang.String",10,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         actionTypeDBFields[4] = new EntityDBFields("actiontype","isCredit","πιστωτικό",0,"java.lang.Boolean",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"","");                       
         actionTypeDBFields[5] = new EntityDBFields("actiontype","actionTraderId","κίνηση συναλλασσόμενου",0,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"actiontrader",FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         actionTypeDBFields[6] = new EntityDBFields("actiontype","actionStockId","κίνηση αποθήκης",0,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"actionstock",FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         ...
         actionTypeDBFields[7] = new EntityDBFields("actiontype","actionTypeCatId","κατηγορία παραστατικού",0,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_TABLECONSTANTS,"LTCActionTypeCat", FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         actionTypeDBFields[8] = new EntityDBFields("actiontype","actiontype copy","αντίγραφα",1,"table",FIELD_VISIBLE_AND_EDITABLE,"actiontypecopy",120,CHILDTABLEINPOSITION_INSIDE_EACH_DATAFIELD_PANEL,actionTypeCopyDBFields,FIELD_TABLE_ONEROWATLEAST_SUGGEST,"SELECT * FROM actiontypecopy WHERE actiontypecopy.dbCompanyId LIKE "+VariablesGlobal.globalCompanyId+" ORDER BY actiontypecopy.actionTypeCopyId",null,null,null,null);        
         ...
         actionTypeDBFields[9] = new EntityDBFields("actiontype","isSxRecordActive","ενημέρωση",2,"java.lang.Boolean",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"false","");                       
// actionTypeDBFields[0] = new EntityDBFields("actiontypeheader","actiontype","τύποι παραστατικών",0,"table",FIELD_VISIBLE_AND_EDITABLE,"actiontype",130,CHILDTABLEINPOSITION_BORDER_LAYOUT_CENTER_SIZABLE,actionTypeLineDBFields,FIELD_TABLE_NOROWCOMPLETION,"SELECT * FROM actiontype ORDER BY actionTypeId",null);     //String[] childTableFieldsForSumsIn   
         actionTypeDBFields[10] = new EntityDBFields("actiontype","sxActionTypeId","τύπος",2,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"sxactiontype",FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         actionTypeDBFields[11] = new EntityDBFields("actiontype","sxAccount1","λογαριασμός πρωτοβάθμιος",2,"java.lang.String",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         
         
         
         actionTypeEntityGroupOfComps[0] = new EntityGroupOfComps("ιδιότητες",4,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);     
        //actionTypeEntityGroupOfComps[1] = new EntityGroupOfComps("εκτύπωση",4,0);
        actionTypeEntityGroupOfComps[1] = new EntityGroupOfComps("αντίγραφα",1,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
        actionTypeEntityGroupOfComps[2] = new EntityGroupOfComps("ενημέρωση εσόδων εξόδων",6,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
         ...
         actionseriesDBFields[1] = new EntityDBFields("actionseries","dbCompanyId","dbCompanyId",0,"java.lang.String",10,FIELD_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,VariablesGlobal.globalCompanyId,"");
         actionseriesDBFields[2] = new EntityDBFields("actionseries","descr","ονομασία",0,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
         actionseriesDBFields[3] = new EntityDBFields("actionseries","actionSeriesCode","σειρά παραστατικού",0,"java.lang.String",8,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         actionseriesDBFields[4] = new EntityDBFields("actionseries","actionTypeId","τύπος παραστατικού",0,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_ONLYONE_THISFIELD,"actiontype", FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");
         actionseriesDBFields[5] = new EntityDBFields("actionseries","seriesNextNumber","επόμενος αριθμός παραστατικού",0,"java.lang.Integer",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null, FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"1","");
         actionseriesDBFields[6] = new EntityDBFields("actionseries","isActive","ενεργός",0,"java.lang.Boolean",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"true","");                 
         ...
         actionseriesEntityGroupOfComps[0] = new EntityGroupOfComps("βασικά",4,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);      
         actionseriesEntityGroupOfComps[1] = new EntityGroupOfComps("εκτύπωση",6,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
         ...
         actiontraderDBFields[1] = new EntityDBFields("actiontrader","dbCompanyId","dbCompanyId",0,"java.lang.String",10,FIELD_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,VariablesGlobal.globalCompanyId,"");         
         actiontraderDBFields[2] = new EntityDBFields("actiontrader","descr","ονομασία",0,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
         actiontraderDBFields[3] = new EntityDBFields("actiontrader","actionType","επηρεάζει",0,"java.lang.Integer",7,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_TABLECONSTANTS,"LTCActionTraderType",FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"1","");
         
         
         actiontraderEntityGroupOfComps[0] = new EntityGroupOfComps("βασικά",6,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
         ...
         actionstockDBFields[1] = new EntityDBFields("actionstock","dbCompanyId","dbCompanyId",0,"java.lang.String",10,FIELD_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_NOT_VISIBLE,VariablesGlobal.globalCompanyId,"");
         actionstockDBFields[2] = new EntityDBFields("actionstock","descr","ονομασία",0,"java.lang.String",30,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,null,"");        
         actionstockDBFields[3] = new EntityDBFields("actionstock","affectType","επηρεάζει",0,"java.lang.Integer",7,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_TABLECONSTANTS,"LTCActionStockAffectType",FIELD_SUGGEST,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"1","");
         actionstockDBFields[4] = new EntityDBFields("actionstock","affectsQuantity","επηρεάζει ποσότητα",0,"java.lang.Boolean",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"","");        
         actionstockDBFields[5] = new EntityDBFields("actionstock","affectsValue","επηρεάζει αξία",0,"java.lang.Boolean",5,FIELD_NORMAL_NO_PRIMARY_KEY,LOOKUPTYPE_NOLOOKUP,null,FIELD_NOCOMPLETION,FIELD_VALIDATION_NO,FIELD_VISIBLE_AND_EDITABLE,"","");        
         
         
         actionstockEntityGroupOfComps[0] = new EntityGroupOfComps("βασικά",6,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);
     ...
     //------------------------------------------sxactiontype-----------------------------------------
       ...
       // esoexoTypeDBFields[0] = new EntityDBFields("actiontypeheader","sxactiontype","τύποι παραστατικών",0,"table",FIELD_VISIBLE_AND_EDITABLE,"sxactiontype",130,CHILDTABLEINPOSITION_BORDER_LAYOUT_CENTER_SIZABLE,actionTypeLineDBFields,FIELD_TABLE_NOROWCOMPLETION,"SELECT * FROM sxactiontype ORDER BY sxActionTypeId",null);     //String[] childTableFieldsForSumsIn   
        ...
        sxactionTypeEntityGroupOfComps[1] = new EntityGroupOfComps("εκτύπωση",4,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);  
     ...
     //--------------------------------prefs foresoexo-------------------------------------
       /* companySetEsoExoDBFields[0] = new EntityDBFields("dbCompanySet","dbCompanyId","Νο εταιρίας",0,"java.lang.Integer",4, FIELD_PRIMARY_KEY_AUTOINC,LOOKUPTYPE_NOLOOKUP,null,FIELD_OBLIGATORY,FIELD_VALIDATION_NO,FIELD_VISIBLE_NOT_EDITABLE_ALWAYS,null,VariablesGlobal.globalCompanyId);
        ...
        companySetEsoExoEntityGroupOfComps[0] = new EntityGroupOfComps("",4,0,FONT_SIZE_NOT_SET, GROUP_OF_PANEL_VISIBLE);   
  ...
  public void addEntityInfoNodes()
  {
   ...
   public ArrayList addEntitiesLookupTableConstants(ArrayList <EntityLookupTableConstants> listEntityLookupTableConstants)
   {
       ...
       */
       ...
       //listEntityLookupTableConstants.add(entityLookupTableConstants = new EntityLookupTableConstants("LTCActionTypeCat",null));//luTCDataActionTypeCat));        
       
       listEntityLookupTableConstants.add(entityLookupTableConstants = new EntityLookupTableConstants("LTCIsUserAcc",null));// if null decide by name from db in EntityLookupTableConstants       
...
*/
     ...
     entities.add(entityLookUp = new EntityLookUp("paymenttype","paymenttype","SELECT paymentTypeId AS\"Νο τρόπου πληρωμής\",description AS\"ονομασία\" FROM paymenttype","",null,"","ORDER BY description","","paymentTypeId","Νο τρόπου πληρωμής","paymentTypeId","τρόπος πληρωμής",2,lookUpFieldPaymentType,"τρόπος πληρωμής",10,"java.lang.String",0,null,null,0,null,null,paymenttypeQueryEditable,"τρόπου πληρωμής","τρόπων πληρωμής",null,entityPanelPaymentType,fieldsOnTitlePaymentType, fieldsOnTitleCaptionPaymentType,null,-1,1,null,true,-1,-1,null)); 
     ...
     entities.add(entityLookUp = new EntityLookUp("geocat","geocat","SELECT geoCatId AS\"Νο πόλης\", geoCatName AS\"πόλη/χωριό\", state AS \"νομός\", postCode AS\"ΤΚ\", phoneCode AS\"κωδ τηλ\" FROM geocat","",null,"","ORDER BY geoCatName" ,"","geoCatId","Νο πόλης","geoCatId","πόλη/χωριό",2,lookUpFieldGeoCat,"πόλη/χωριό",16,"java.lang.String",0,null,null,0,null,null,geoCatQueryEditable,"πόλης","πόλεων",null,entityPanelGeoCat,fieldsOnTitleGeoCat, fieldsOnTitleCaptionGeoCat,geoCatErs,-1,1,null,true,-1,-1,null));
  ...
  */
     ...
     entities.add(entityLookUp = new EntityLookUp("vatcat","vatcat","SELECT vatCatId AS\"Νο κατηγορίας ΦΠΑ\", vatDescr AS\"κατηγορία ΦΠΑ\", vatPercentage AS \"ποσοστό\" FROM vatcat","",null,"AND vatcat.active LIKE 1","ORDER BY vatDescr","","vatCatId","Νο κατηγορίας ΦΠΑ","vatCatId","κατηγορία",2,lookUpFieldVatCat,"κατηγορία",7,"java.lang.String",0,null,null,0,null,null,vatCatQueryEditable,"κατηγορία ΦΠΑ","κατηγοριών ΦΠΑ",null,entityPanelVatCat,fieldsOnTitleVatCat, fieldsOnTitleCaptionVatCat,vatCatErs,-1,1,null,true,-1,-1,null));
     ...
     entities.add(entityLookUp = new EntityLookUp("doy","doy","SELECT doyId AS\"Νο Δ.Ο.Υ.\", doyName AS\"ονομασία Δ.Ο.Υ.\" FROM doy","",null,"","ORDER BY doyId","","doyId","Νο Δ.Ο.Υ.","doyId","Δ.Ο.Υ.",2,lookUpFieldDoy,"ονομασία Δ.Ο.Υ.",12,"java.lang.String",0,null,null,0,null,null,doyQueryEditable,"της Δ.Ο.Υ.","Δ.Ο.Υ.",null,entityPanelDoy,fieldsOnTitleDoy, fieldsOnTitleCaptionDoy,doyErs,-1,1,null,true,-1,-1,null));     	 	
   
     
     
  String[] lookUpFieldBank={"bankBranch"};
     entities.add(entityLookUp = new EntityLookUp("bank","bank","SELECT bank.bankId AS\"Νο τράπεζας\", bank.bankBranch AS \"τίτλος τράπεζας\", BIC FROM bank","",null,"","ORDER BY bank.bankBranch","","bankId","Νο τράπεζας","bankId","τράπεζα",2,lookUpFieldBank,"τίτλος τράπεζας",18,"java.lang.String",0,null,null,0,null,null,bankQueryEditable,"τράπεζας","τραπεζών",null,entityPanelBank,fieldsOnTitleBank,fieldsOnTitleCaptionBank,null,-1,1,null,true,-1,-1,null));    	 		
...
*/
  ...
  /*       EntityFilterSettings[] printFormErs = new EntityFilterSettings[1];       
   ...
   //----------------------------------------------------------------  
     ...
     //String[] lookUpFieldLabelPaymentType={"είδος παραστατικού","συντομογραφία",null};
     entities.add(entityLookUp = new EntityLookUp("dbuserrole","dbuserrole","SELECT userRoleId AS\"Νο ρόλου\" ,roleDescr AS\"περιγραφή\", isAccountant, lookupconstants.name FROM dbuserrole INNER JOIN lookupconstants ON dbuserrole.isAccountant = lookupconstants.lookupconstantsId ","WHERE lookupconstants.constantstypeId = 10",null,"","ORDER BY roleDescr","","userRoleId","Νο ρόλου","userRoleId"," Νο ρόλου",2,lookUpFieldRoleDescr,"ρόλος",10,"java.lang.String",0,null,null,0,null,null,dbUserRolesQueryEditable,"ρόλου","ρόλων",null,dbUserRolesEntityPanel,dbUserRolesFieldsOnTitle, dbUserRolesFieldsOnTitleCaption,null,-1,1,null,true,-1,-1,null)); 
...
//     entities.add(entityLookUp = new EntityLookUp("dbyear","dbyear","SELECT dbyearId AS \"χρήση Νο\", dbyear AS \"χρήση\" FROM dbyear","WHERE dbCompanyId LIKE '"+VariablesGlobal.globalCompanyId+"'","", "ORDER BY dbyear" ,"","dbyearId","χρήση","dbyearId","χρήση",2,lookUpFieldDbYear,"χρήση",7,"java.lang.String",0,null,null,0,null,null,"","της χρήσης","των χρήσεων",null,entityPanelDbyear,fieldsOnTitleDbyear,fieldsOnTitleCaptionDbyear,null,-1,1,null,false,-1,-1,null));  
     ...
     // ------------------------ lookup servicesales transactions below---------
        ...
        String[] lookUpFieldActionType={"actionTypeDescription"};                      
     entities.add(entityLookUp = new EntityLookUp("actiontype","actiontype","SELECT actiontype.actionTypeId AS\"Νο τύπου παραστατικού\", actiontype.actionTypeCode AS\"κωδικός\", actiontype.actionTypeDescription AS \"ονομασία τύπου παραστατικού\" ,actiontype.isCredit  AS\"πιστωτικό\", lookupconstants.name  FROM actiontype INNER JOIN lookupconstants ON actiontype.actionTypeCatId = lookupconstants.lookupconstantsId","WHERE lookupconstants.constantstypeId = 2 AND  actiontype.dbCompanyId LIKE "+VariablesGlobal.globalCompanyId,null,"","ORDER BY actiontype.actionTypeCatId, actiontype.actionTypeId","","actionTypeId","Νο τύπου παραστατικού","actionTypeId","τύπος παραστατικού",3,lookUpFieldActionType,"ονομασία",33,"java.lang.String",0,null,null,0,null,null,actionTypeQueryEditable,"τυπου παραστατικού","τύπων παραστατικών",null,entityPanelActionType,fieldsOnTitleActionType,fieldsOnTitleCaptionActionType,actionTypeErs,-1,1,null,true,-1,-1,null));    	 	
  ...
  //--------------------------------------- -----------------------------
     ...
     entities.add(entityLookUp = new EntityLookUp("actionseries","actionseries","SELECT actionseriesId AS\"Νο\", descr AS\"ονομασία\", actionSeriesCode, seriesNextNumber FROM actionseries","WHERE actionseries.dbCompanyId LIKE "+VariablesGlobal.globalCompanyId,null,"","ORDER BY actionseriesId","","actionseriesId","Νο","actionseriesId","σειρές",2,actionseriesLookUpField,"ονομασία",32,"java.lang.String",0,null,null,0,null,null,actionseriesQueryEditable,"της σειράς","σειρές",null,actionseriesEntityPanel,actionseriesFieldsOnTitle, actionseriesFieldsOnTitleCaption,actionseriesErs,-1,1,null,true,-1,-1,null));     	 	
    ...
    //-------------------------------------------------------------------------------
     ...
     entities.add(entityLookUp = new EntityLookUp("actionstock","actionstock","SELECT actionstockId AS\"Νο\", descr AS\"ονομασία\", affectType, affectsQuantity, affectsValue FROM actionstock","WHERE actionstock.dbCompanyId LIKE "+VariablesGlobal.globalCompanyId,null,"","ORDER BY actionstockId","","actionstockId","Νο","actionstockId","τύποι αποθήκης",2,actionstockLookUpField,"ονομασία",18,"java.lang.String",0,null,null,0,null,null,actionstockQueryEditable,"της κίνησης αποθήκης","κινήσεων αποθήκης",null,actionstockEntityPanel,actionstockFieldsOnTitle, actionstockFieldsOnTitleCaption,actionstockErs,-1,1,null,true,-1,-1,null));     	 	
   ...
   //-------------------------------------------------------------------------------
     ...
     entities.add(entityLookUp = new EntityLookUp("sxmyftype","sxmyftype","SELECT lookupconstantsId AS \"id \",  name AS \"είδος ΜΥΦ \"  FROM lookupconstants  ","WHERE constantstypeId =3 AND lookupconstantsId NOT LIKE 5",null,"","ORDER BY constantsorder","","lookupconstantsId","Νο τύπου ΜΥΦ","lookupconstantsId","τύπος ΜΥΦ",3,lookUpFieldsxMyfType,"ονομασία",33,"java.lang.String",0,null,null,0,null,null,null,"τυπου ΜΥΦ","τύπων ΜΥΦ",null,null/*entityPanelsxActionType*/,null,null,sxMyfTypeErs,-1,1,null,true,-1,-1,null));    	 	
     ...
     //String[] lookUpFieldLabelPaymentType={"είδος παραστατικού","συντομογραφία",null};
     entities.add(entityLookUp = new EntityLookUp("doykad","doykad","SELECT doyKadId AS\"Νο\",kadCode AS\"κωδικός\", description AS\"περιγραφή\" FROM doykad","",null,"","ORDER BY kadCode","","doyKadId","Νο","doyKadId","ΔΟΥ ΚΑΔ",3,lookUpFieldDoyKad,"ΔΟΥ ΚΑΔ",10,"java.lang.String",0,null,null,0,null,null,doyKadQueryEditable,"ΔΟΥ ΚΑΔ","ΔΟΥ ΚΑΔ",null,entityPanelDoyKad,fieldsOnTitleDoyKad, fieldsOnTitleCaptionDoyKad,doykadErs,2,1,null,false,-1,-1,null)); 
     //entities.add(entityLookUp = new EntityLookUp("paymenttype","SELECT paymentTypeId AS\"Νο τύπου παρ/κού\",paymentTypeName AS\"ονομασία τύπου παρ/κού\", abbreviation AS\"συντομογραφία\" FROM paymenttype","ORDER BY paymentTypeName","paymentTypeId","Νο τύπου παρ/κού",2,lookUpFieldPaymentType,"είδος παραστατικού",0,null,null,0,null,null,paymenttypeQueryEditable,"τύπου παραστατικού","τύπων παραστατικού",null,entityPanelPaymentType,fieldsOnTitlePaymentType, fieldsOnTitleCaptionPaymentType,null,2,1,null,true,-1,-1)); 
...
*/        
 //       EntityParameter ph = new EntityParameter("dbyear", "SELECT dbyear.dbYearId AS \"Νο χρήσης\", dbyear.dbyear AS\"χρήση\" FROM dbyear  WHERE dbyear.dbcompanyid='"+VariablesGlobal.globalCompanyId+"' ORDER BY  dbyear.dbYearId" ,"SELECT dbYearId AS\"Νο χρήσης\", dbyear AS\"χρήση\", dbcompanyid AS\"Νο εταιρίας\"","FROM dbyear","",fieldsForSumsDbYear,dbyearDBFields ,"έτη/χρήσεις", "DORM","Νο χρήσης","dbYearId", dbYearErs,null,"χρήσης","χρήσεων",entityPanelDbyear,null,fieldsOnTitleDbyear,fieldsOnTitleCaptionDbyear,yearFieldsOrderby,-1,-1,globalYearPlusOne/*,"",""*/);//SELECT dbyear.dbYearId AS "Νο χρήσης", dbyear.dbyear AS"χρήση", Count(aa) AS "πλήθος περίοδων" FROM dbyear, dbYearDelivery  WHERE dbyear.dbYearId = dbYearDelivery.dbYearId AND dbyear.dbcompanyid='1' GROUP BY dbyear.dbYearId ORDER BY dbyear.dbYearId        
     ...
     PanelCopyAllFromCompany panelDataCopyFromCompany = new PanelCopyAllFromCompany();
        ...
        EntityParameter pj = new EntityParameter("dbuserrole", "SELECT userRoleId AS\"Νο ρόλου\", roleDescr AS\"όνομα ρόλου\", isAccountant, lookupconstants.name  FROM dbuserrole INNER JOIN lookupconstants ON dbuserrole.isAccountant = lookupconstants.lookupconstantsId WHERE lookupconstants.constantstypeId = 10"  ,"SELECT userRoleId AS\"Νο ρόλου\", roleDescr AS\"όνομα ρόλου\", isAccountant","FROM dbuserrole","",dbUserRolesFieldsForSums,dbUserRolesDBFields ,"ρόλοι", "DORM","Νο ρόλου","userRoleId", null,null,"ρόλου","ρόλων",dbUserRolesEntityPanel,null,dbUserRolesFieldsOnTitle,dbUserRolesFieldsOnTitleCaption,dbUserRolesFieldsOrderby,-1,-1,globalYearPlusOne/*,"",""*/);
